...
import problemData from '@/data/problems/part-03.json';

export default function ProblemsPart04() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering the theory of continuous functions: epsilon-delta definitions,
            limit theorems, composite functions, Bolzano's theorem (IVT), inverse functions,
