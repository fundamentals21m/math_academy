      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering the foundational concepts of integral calculus:
            functions, the area axioms, step functions, partitions, and the definition of
            the integral via upper and lower sums.
          </p>
        </motion.div>
