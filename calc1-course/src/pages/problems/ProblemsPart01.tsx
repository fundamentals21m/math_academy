...
import problemData from '@/data/problems/part-00.json';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering the historical development of calculus, the method of
            exhaustion, set theory, real numbers, mathematical induction, and summation notation.
          </p>
        </motion.div>
