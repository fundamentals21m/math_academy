...
import problemData from '@/data/problems/part-11.json';

export default function ProblemsPart12() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering pointwise convergence, uniform convergence, the Weierstrass M-test,
            power series and radius of convergence, Taylor series and Maclaurin series, and the binomial series.
          </p>
        </motion.div>
