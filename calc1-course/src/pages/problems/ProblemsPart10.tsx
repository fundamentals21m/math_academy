...
import problemData from '@/data/problems/part-09.json';

export default function ProblemsPart10() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering complex number arithmetic, the complex plane and polar form,
            Euler's formula, De Moivre's theorem, roots of unity, and complex-valued functions.
          </p>
        </motion.div>
