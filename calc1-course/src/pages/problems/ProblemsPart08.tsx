...
import problemData from '@/data/problems/part-07.json';

export default function ProblemsPart08() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering Taylor polynomials, Taylor's formula with remainder,
            Big O and little o notation, L'Hôpital's rule, and operations with Taylor series.
          </p>
        </motion.div>
