...
import problemData from '@/data/problems/part-05.json';

export default function ProblemsPart06() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering the Fundamental Theorems of Calculus and integration techniques:
            the First and Second Fundamental Theorems, integration by substitution, and integration by parts.
          </p>
        </motion.div>
