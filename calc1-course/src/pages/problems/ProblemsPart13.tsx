...
import problemData from '@/data/problems/part-12.json';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering vectors in n-space, dot products, norms and distances,
            orthogonality, projections, linear span, linear independence, and bases.
          </p>
        </motion.div>
