...
import problemData from '@/data/problems/part-10.json';

export default function ProblemsPart11() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering sequences, infinite series, convergence tests (comparison, ratio, root, integral),
            alternating series, absolute and conditional convergence, and improper integrals.
          </p>
        </motion.div>
