...
import problemData from '@/data/problems/part-04.json';

export default function ProblemsPart05() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering differential calculus: the derivative definition,
            differentiation rules (sum, product, quotient, chain), geometric interpretation,
            related rates, extrema, the mean value theorem, and curve sketching.
          </p>
        </motion.div>
