...
import problemData from '@/data/problems/part-08.json';

export default function ProblemsPart09() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering first-order linear, separable, and homogeneous equations,
            second-order linear equations with constant coefficients, variation of parameters, and applications.
          </p>
        </motion.div>
