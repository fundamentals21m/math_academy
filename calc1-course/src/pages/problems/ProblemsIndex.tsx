...
// Note: curriculum parts are 1-indexed, files are 0-indexed
const problemDataByPart: Record<number, typeof part00Data | null> = {
  1: part00Data,
  2: part01Data,
  3: part02Data,
  4: part03Data,
...
export default function ProblemsIndex() {
  ...
  const overallStats = useMemo(() => {
    const allIds = Object.values(problemDataByPart)
      .filter((data): data is typeof part00Data => data !== null)
      .flatMap((data) =>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400">
            Practice problems and worked examples from Apostol's Calculus, Volume 1
          </p>
        </motion.div>
        ...
        >
          ...
          <ul className="text-sm text-dark-400 space-y-1">
            <li>
              <span className="text-amber-400">Examples</span> are worked problems from the textbook with detailed solutions
            </li>
            <li>
              <span className="text-emerald-400">Exercises</span> are end-of-section problems with solutions
            </li>
