      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering applications of integration: area between curves,
            trigonometric functions, polar coordinates, volumes of revolution, work, average value,
