 ...
 */
export const COURSE_ID: CourseId = 'numbers-geometry';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Numbers and Geometry';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'An interactive course exploring the deep connections between numbers and geometry';
