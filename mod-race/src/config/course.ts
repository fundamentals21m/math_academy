 ...
 */
export const COURSE_ID: CourseId = 'mod-race';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Modular Arithmetic Racing';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'Race to master modular arithmetic with competitive math challenges';
