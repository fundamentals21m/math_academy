      ...
      <article className="relative max-w-4xl mx-auto px-6 py-12">
        ...
        <header className="mb-14">
          ...
          <div className="p-4 rounded-xl bg-dark-800/50 border border-dark-700/50 mb-6">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-dark-500 mb-3">Author</h3>
        ...
        <div className="mt-12 p-6 rounded-2xl bg-gradient-to-br from-indigo-500/10 to-indigo-600/5 border border-indigo-500/20">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-indigo-400 font-semibold mb-1">Original Article</h3>
              <p className="text-dark-400 text-sm mb-3">
                This is an educational summary. Read the full original article at Orthogonal Divergence.
              </p>
              <a
