        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-dark-100">Articles</h1>
                <p className="text-dark-400">
                  Bitcoin analysis for institutional investors
                </p>
              </div>
            </div>

            <p className="text-dark-400 text-sm max-w-3xl">
              Curated summaries from Orthogonal Divergence covering institutional Bitcoin adoption,
              credit rating methodologies, treasury company analysis, pension fund strategies,
              and economic frameworks for understanding Bitcoin.
            </p>
          </div>
          ...
          <p className="text-dark-500 text-sm mb-4">
            {filteredTranscripts.length} article{filteredTranscripts.length !== 1 ? 's' : ''} found
          </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mb-3">
                      <span className="text-xs text-dark-500">Author:</span>
          ...
          {filteredTranscripts.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-dark-400 mb-2">No articles found</p>
          ...
          <div className="mt-12 p-6 rounded-2xl bg-dark-800/30 border border-dark-700/30">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-dark-100 font-semibold mb-1">More at Orthogonal Divergence</h3>
                <p className="text-dark-400 text-sm mb-3">
                  These are curated summaries. Find the full original articles and more
                  Bitcoin analysis for institutional investors at Orthogonal Divergence.
                </p>
                <a
                  href="https://fundamentals.ghost.io"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-indigo-400 text-sm hover:text-indigo-300 transition-colors"
                >
                  Visit fundamentals.ghost.io
