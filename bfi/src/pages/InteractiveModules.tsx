...
const modules: InteractiveModule[] = [
  {
    ...
    description: 'See how Bitcoin allocation affects portfolio metrics like Sharpe ratio, volatility, and expected returns.',
    sectionId: 10,
    sectionTitle: 'Mutual Funds / ETFs – Wielding the Blade',
    category: 'Portfolio',
    icon: '📊',
  },
  {
    id: 'treasury-growth',
    title: 'Treasury Growth Simulator',
    description: 'Model Strategy-style Bitcoin accumulation over time with continuous purchases and appreciation.',
    sectionId: 7,
    sectionTitle: 'Strategy (Balance Sheet Strength)',
    category: 'Treasury',
    icon: '📈',
  },
  {
    id: 'inflation-calculator',
    title: 'Cash vs Bitcoin Calculator',
    description: 'Compare how cash loses purchasing power to inflation while Bitcoin appreciates over time.',
    sectionId: 2,
    sectionTitle: 'Bitcoin Requires a Deflationary Mindset',
    category: 'Economics',
    icon: '💸',
  },
];
