 ...
 */
export const COURSE_ID: CourseId = 'bfi';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Bitcoin for Institutions';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'An interactive course on Bitcoin for institutional investors';
