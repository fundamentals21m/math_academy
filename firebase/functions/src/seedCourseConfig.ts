...
const COURSES = [
  ...
  { id: 'bfi', title: 'Bitcoin for Institutions', description: "A comprehensive guide to institutional Bitcoin adoption.", icon: '₿', url: 'bfi-deploy/', tags: ['3 Parts', '15 Sections'], sections: ['featured'], totalSections: 15, progressPrefix: 'bfi:', leaderboardUrl: 'bfi-deploy/#/leaderboard', shortName: 'BFI', progressGradient: 'linear-gradient(90deg, #f97316, #fbbf24)' },
