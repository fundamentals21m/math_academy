...
const COURSES = [
  ...
  { id: 'df', title: 'Abstract Algebra (Dummit & Foote)', description: "The definitive graduate-level abstract algebra textbook.", icon: 'G', url: 'https://df-course-deploy.vercel.app/', tags: ['6 Parts', '95 Sections'], sections: ['algebra'], totalSections: 95, progressPrefix: 'df:', leaderboardUrl: 'https://df-course-deploy.vercel.app/#/leaderboard', shortName: 'Dummit-Foote', progressGradient: 'linear-gradient(90deg, #e11d48, #f43f5e)' },
