...
const COURSES = [
  ...
  { id: 'islr', title: 'Intro to Statistical Learning', description: "Master machine learning fundamentals.", icon: '📊', url: 'islr-deploy/', tags: ['13 Chapters', '10 Sections'], sections: ['prob_stats'], totalSections: 10, progressPrefix: 'islr:', leaderboardUrl: 'islr-deploy/#/leaderboard', shortName: 'Statistical Learning', progressGradient: 'linear-gradient(90deg, #34d399, #6ee7b7)' },
  { id: 'bfi', title: 'Bitcoin for Institutions', description: "A comprehensive guide to institutional Bitcoin adoption.", icon: '₿', url: 'https://bfi-liart.vercel.app/', tags: ['3 Parts', '15 Sections'], sections: ['featured'], totalSections: 15, progressPrefix: 'bfi:', leaderboardUrl: 'https://bfi-liart.vercel.app/#/leaderboard', shortName: 'BFI', progressGradient: 'linear-gradient(90deg, #f97316, #fbbf24)', youtubePlaylistUrl: 'https://www.youtube.com/playlist?list=PLaAxhhFb7OVHBl4fi5SmDiLeccl9hsB2m' },
