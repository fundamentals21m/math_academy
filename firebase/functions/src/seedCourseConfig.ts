...
const COURSES = [
  ...
  { id: 'frost', title: 'FROST: Threshold Signatures', description: 'Master Flexible Round-Optimized Schnorr Threshold Signatures - from mathematical foundations to Bitcoin applications.', icon: '🔐', url: 'https://frost-deploy.vercel.app/', tags: ['10 Parts', '69 Sections'], sections: ['featured', 'number_theory'], totalSections: 69, progressPrefix: 'frost:', leaderboardUrl: 'https://frost-deploy.vercel.app/#/leaderboard', shortName: 'FROST', progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)' },
  { id: 'islr', title: 'Intro to Statistical Learning', description: "Master machine learning fundamentals.", icon: '📊', url: 'https://islr-deploy.vercel.app/', tags: ['13 Chapters', '62 Sections'], sections: ['prob_stats'], totalSections: 62, progressPrefix: 'islr:', leaderboardUrl: 'https://islr-deploy.vercel.app/#/leaderboard', shortName: 'Statistical Learning', progressGradient: 'linear-gradient(90deg, #34d399, #6ee7b7)' },
  ...
  { id: 'bips', title: 'Bitcoin Improvement Proposals', description: 'A comprehensive course covering 100+ Bitcoin Improvement Proposals.', icon: '📜', url: 'https://bips-deploy.vercel.app/', tags: ['8 Parts', '95 Sections'], sections: ['featured', 'number_theory'], totalSections: 95, progressPrefix: 'bips:', leaderboardUrl: 'https://bips-deploy.vercel.app/#/leaderboard', shortName: 'BIPs', progressGradient: 'linear-gradient(90deg, #f97316, #fbbf24)' },
  { id: 'calc_easy', title: 'Beginner Calculus', description: "Master calculus through Silvanus P. Thompson's timeless classic.", icon: '∂', url: 'https://calceasy-deploy.vercel.app/', tags: ['26 Sections', 'Interactive'], sections: ['beginners', 'calculus'], totalSections: 26, progressPrefix: 'calc_easy:', leaderboardUrl: 'https://calceasy-deploy.vercel.app/#/leaderboard', shortName: 'Beginner Calculus', progressGradient: 'linear-gradient(90deg, #f59e0b, #fbbf24)' },
  { id: 'ba', title: 'Basic Algebra', description: 'Master the fundamentals of algebra through interactive lessons.', icon: 'x²', url: 'https://basic-algebra-deploy.vercel.app/', tags: ['17 Chapters', '64 Sections'], sections: ['beginners', 'algebra'], totalSections: 64, progressPrefix: 'ba:', leaderboardUrl: 'https://basic-algebra-deploy.vercel.app/#/leaderboard', shortName: 'Basic Algebra', progressGradient: 'linear-gradient(90deg, #22c55e, #4ade80)' },
  { id: 'wm', title: 'Why Math?', description: "Discover the real reasons behind mathematical concepts.", icon: '📚', url: 'https://why-math-deploy.vercel.app/', tags: ['8 Parts', '13 Sections'], sections: ['beginners'], totalSections: 13, progressPrefix: 'wm:', leaderboardUrl: 'https://why-math-deploy.vercel.app/#/leaderboard', shortName: 'Why Math?', progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)' },
  { id: 'calc1', title: 'Intermediate Calculus', description: "One-variable calculus with an introduction to linear algebra.", icon: '∫', url: 'https://calc1-deploy.vercel.app/', tags: ['17 Parts', '101 Sections'], sections: ['calculus'], totalSections: 101, progressPrefix: 'calc1:', leaderboardUrl: 'https://calc1-deploy.vercel.app/#/leaderboard', shortName: 'Intermediate Calculus', progressGradient: 'linear-gradient(90deg, #f97316, #fb923c)' },
  { id: 'calc2', title: 'Advanced Calculus', description: "Multi-variable calculus and linear algebra with applications to differential equations and probability.", icon: '∫∫', url: 'https://calc2-deploy.vercel.app/', tags: ['15 Parts', '191 Sections'], sections: ['calculus', 'algebra'], totalSections: 191, progressPrefix: 'calc2:', leaderboardUrl: 'https://calc2-deploy.vercel.app/#/leaderboard', shortName: 'Advanced Calculus', progressGradient: 'linear-gradient(90deg, #8b5cf6, #a78bfa)' },
  { id: 'calc_lib_art', title: 'Calculus as a Liberal Art', description: 'Explore calculus through a liberal arts lens.', icon: '📚', url: 'https://calc-lib-art-deploy.vercel.app/', tags: ['Interactive', 'Conceptual'], sections: ['calculus'], totalSections: 15, progressPrefix: 'calc_lib_art:', leaderboardUrl: 'https://calc-lib-art-deploy.vercel.app/#/leaderboard', shortName: 'Calc Liberal Art', progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)' },
  { id: 'ra', title: 'Introduction to Real Analysis', description: "A rigorous introduction to real analysis.", icon: '📐', url: 'https://ra-deploy.vercel.app/', tags: ['4 Parts', '15 Sections'], sections: ['calculus'], totalSections: 15, progressPrefix: 'ra:', leaderboardUrl: 'https://ra-deploy.vercel.app/#/leaderboard', shortName: 'Real Analysis', progressGradient: 'linear-gradient(90deg, #10b981, #34d399)' },
  { id: 'rudin', title: 'Principles of Mathematical Analysis', description: "The classic 'Baby Rudin' - a rigorous introduction to real analysis covering sequences, series, continuity, differentiation, integration, and Lebesgue theory.", icon: '∫', url: 'https://rudin-deploy.vercel.app/', tags: ['11 Parts', '86 Sections'], sections: ['calculus'], totalSections: 86, progressPrefix: 'rudin:', leaderboardUrl: 'https://rudin-deploy.vercel.app/#/leaderboard', shortName: 'Baby Rudin', progressGradient: 'linear-gradient(90deg, #06b6d4, #22d3ee)' },
  { id: 'tao-analysis-1', title: "Tao's Analysis I", description: "A rigorous introduction to real analysis by Terence Tao, building from Peano axioms through real numbers, sequences, series, continuity, differentiation, and Riemann integration.", icon: 'ε', url: 'https://tao-analysis-1-deploy.vercel.app/', tags: ['13 Parts', '72 Sections'], sections: ['calculus', 'seminal'], totalSections: 72, progressPrefix: 'tao-analysis-1:', leaderboardUrl: 'https://tao-analysis-1-deploy.vercel.app/#/leaderboard', shortName: 'Tao Analysis I', progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)' },
  { id: 'tao2', title: "Tao's Analysis II", description: "The sequel to Analysis I, covering metric spaces, continuous functions, uniform convergence, power series, Fourier series, several variable calculus, Lebesgue measure, and Lebesgue integration.", icon: 'δ', url: 'https://tao2-deploy.vercel.app/', tags: ['8 Parts', '48 Sections'], sections: ['calculus', 'seminal'], totalSections: 48, progressPrefix: 'tao2:', leaderboardUrl: 'https://tao2-deploy.vercel.app/#/leaderboard', shortName: 'Tao Analysis II', progressGradient: 'linear-gradient(90deg, #8b5cf6, #a78bfa)' },
  { id: 'linalg', title: 'Linear Algebra', description: "Master vectors, matrices, and linear transformations.", icon: '📐', url: 'https://linalg-deploy.vercel.app/', tags: ['Vectors & Matrices', 'Interactive'], sections: ['algebra'], totalSections: 50, progressPrefix: 'linalg:', leaderboardUrl: 'https://linalg-deploy.vercel.app/#/leaderboard', shortName: 'Linear Algebra', progressGradient: 'linear-gradient(90deg, #06b6d4, #22d3ee)' },
  { id: 'advlinalg', title: 'Advanced Linear Algebra', description: "Deep dive into abstract linear algebra.", icon: 'ℳ', url: 'https://advlinalg-deploy.vercel.app/', tags: ['10 Chapters', '59 Sections'], sections: ['algebra'], totalSections: 12, progressPrefix: 'advlinalg:', leaderboardUrl: 'https://advlinalg-deploy.vercel.app/#/leaderboard', shortName: 'Advanced LinAlg', progressGradient: 'linear-gradient(90deg, #a855f7, #c084fc)' },
  { id: 'aa', title: 'Abstract Algebra', description: 'Explore the elegant world of algebraic structures.', icon: 'G', url: 'https://aa-deploy.vercel.app/', tags: ['Groups & Rings', 'Fields'], sections: ['algebra'], totalSections: 50, progressPrefix: 'aa:', leaderboardUrl: 'https://aa-deploy.vercel.app/#/leaderboard', shortName: 'Abstract Algebra', progressGradient: 'linear-gradient(90deg, #f97316, #fb923c)' },
  { id: 'df', title: 'Abstract Algebra (Dummit & Foote)', description: "The definitive graduate-level abstract algebra textbook.", icon: 'G', url: 'https://df-deploy.vercel.app/', tags: ['6 Parts', '95 Sections'], sections: ['algebra'], totalSections: 95, progressPrefix: 'df:', leaderboardUrl: 'https://df-deploy.vercel.app/#/leaderboard', shortName: 'Dummit-Foote', progressGradient: 'linear-gradient(90deg, #e11d48, #f43f5e)' },
  { id: 'four_pillars', title: 'The Four Pillars of Geometry', description: "Explore geometry from four perspectives.", icon: '🔺', url: 'https://four-pillars-deploy.vercel.app/', tags: ['8 Chapters', '66 Sections'], sections: ['geometry'], totalSections: 66, progressPrefix: 'four_pillars:', leaderboardUrl: 'https://four-pillars-deploy.vercel.app/#/leaderboard', shortName: 'Four Pillars', progressGradient: 'linear-gradient(90deg, #ec4899, #f472b6)' },
  { id: 'numbers_geometry', title: 'Numbers and Geometry', description: "Explore the deep connections between arithmetic and geometry.", icon: '🔢', url: 'https://numbers-geometry-deploy.vercel.app/', tags: ['9 Chapters', '79 Sections'], sections: ['geometry'], totalSections: 79, progressPrefix: 'numbers_geometry:', leaderboardUrl: 'https://numbers-geometry-deploy.vercel.app/#/leaderboard', shortName: 'Numbers & Geometry', progressGradient: 'linear-gradient(90deg, #14b8a6, #2dd4bf)' },
  ...
  { id: 'gauss', title: "Disquisitiones Arithmeticae", description: "Gauss's foundational 1801 treatise.", icon: '🔢', url: 'https://gauss-deploy.vercel.app/', tags: ['7 Sections', 'Number Theory'], sections: ['seminal'], totalSections: 7, progressPrefix: 'gauss:', leaderboardUrl: 'https://gauss-deploy.vercel.app/#/leaderboard', shortName: 'Disquisitiones', progressGradient: 'linear-gradient(90deg, #d97706, #f59e0b)' },
  { id: 'only_the_strong_survive', title: 'Only The Strong Survive', description: "A critique of prospects in crypto beyond Bitcoin.", icon: '₿', url: 'https://only-the-strong-survive-deploy.vercel.app/', tags: ['8 Parts', '20 Sections'], sections: ['seminal'], totalSections: 20, progressPrefix: 'only_the_strong_survive:', leaderboardUrl: 'https://only-the-strong-survive-deploy.vercel.app/#/leaderboard', shortName: 'Only The Strong', progressGradient: 'linear-gradient(90deg, #f97316, #fbbf24)' },
  ...
  { id: 'mom', title: 'Men of Mathematics', description: "Journey through 2500 years of mathematical history.", icon: '📜', url: 'https://mom-deploy.vercel.app/', tags: ['34 Sections', 'Interactive'], sections: ['history'], totalSections: 34, progressPrefix: 'mom:', leaderboardUrl: 'https://mom-deploy.vercel.app/#/leaderboard', shortName: 'Men of Math', progressGradient: 'linear-gradient(90deg, #8b5cf6, #a78bfa)' },
  { id: 'thales', title: 'The Heritage of Thales', description: "Journey through 2,500 years of mathematical history.", icon: '🏛️', url: 'https://thales-deploy.vercel.app/', tags: ['11 Parts', '66 Sections'], sections: ['history'], totalSections: 66, progressPrefix: 'thales:', leaderboardUrl: 'https://thales-deploy.vercel.app/#/leaderboard', shortName: 'Heritage of Thales', progressGradient: 'linear-gradient(90deg, #f59e0b, #fbbf24)' },
  ...
  { id: 'human_action', title: 'Human Action', description: "Ludwig von Mises' foundational treatise on economics.", icon: '📖', url: 'https://human-action-deploy.vercel.app/', tags: ['8 Parts', '40 Sections'], sections: ['austrian'], totalSections: 40, progressPrefix: 'human_action:', leaderboardUrl: 'https://human-action-deploy.vercel.app/#/leaderboard', shortName: 'Human Action', progressGradient: 'linear-gradient(90deg, #f59e0b, #fbbf24)' },
  ...
  { id: 'west_graphs', title: 'Introduction to Graph Theory', description: "Master graph theory.", icon: '🕸️', url: 'https://west-graphs-deploy.vercel.app/', tags: ['8 Chapters', '28 Sections'], sections: ['discrete'], totalSections: 28, progressPrefix: 'west_graphs:', leaderboardUrl: 'https://west-graphs-deploy.vercel.app/#/leaderboard', shortName: 'Graph Theory', progressGradient: 'linear-gradient(90deg, #8b5cf6, #a78bfa)' },
  { id: 'coding_theory', title: 'Algebraic Coding Theory', description: "Master error-correcting codes.", icon: '🔢', url: 'https://coding-theory-deploy.vercel.app/', tags: ['11 Chapters', '41 Sections'], sections: ['discrete'], totalSections: 41, progressPrefix: 'coding_theory:', leaderboardUrl: 'https://coding-theory-deploy.vercel.app/#/leaderboard', shortName: 'Coding Theory', progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)' },
  { id: 'intro-discrete', title: 'Intro to Discrete Math', description: "Numbers, groups, and codes.", icon: '🔢', url: 'https://intro-discrete-deploy.vercel.app/', tags: ['6 Chapters', '26 Sections'], sections: ['discrete'], totalSections: 26, progressPrefix: 'intro-discrete:', leaderboardUrl: 'https://intro-discrete-deploy.vercel.app/#/leaderboard', shortName: 'Intro Discrete', progressGradient: 'linear-gradient(90deg, #8b5cf6, #a78bfa)' },
  { id: 'koblitz', title: 'Advanced Number Theory and Cryptography', description: "A rigorous course in number theory.", icon: '🔑', url: 'https://koblitz-course-deploy.vercel.app/', tags: ['3 Parts', '22 Sections'], sections: ['number_theory'], totalSections: 22, progressPrefix: 'koblitz:', leaderboardUrl: 'https://koblitz-course-deploy.vercel.app/#/leaderboard', shortName: 'Koblitz', progressGradient: 'linear-gradient(90deg, #f59e0b, #fbbf24)' },
  { id: 'ross-prob', title: 'Probability', description: "Master probability theory.", icon: '🎲', url: 'https://ross-prob-deploy.vercel.app/', tags: ['10 Chapters', '66 Sections'], sections: ['prob_stats'], totalSections: 9, progressPrefix: 'ross-prob:', leaderboardUrl: 'https://ross-prob-deploy.vercel.app/#/leaderboard', shortName: 'Probability', progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)' },
  { id: 'mod-race', title: 'Mod Racing', description: 'Race to master modular arithmetic with competitive math challenges.', icon: '🏎️', url: 'https://mod-race-deploy.vercel.app/', tags: ['10 Tiers', 'Multiplayer'], sections: ['games'], totalSections: 10, progressPrefix: 'mod-race:', leaderboardUrl: 'https://mod-race-deploy.vercel.app/#/leaderboard', shortName: 'Mod Racing', progressGradient: 'linear-gradient(90deg, #22d3ee, #6366f1)' },
  ...
  { id: 'branta', title: 'Branta: Bitcoin Transaction Security', description: 'Learn pre-payment verification with Guardrail. Protect against address swaps, phishing, MITM attacks, and supply chain compromises.', icon: '🛡️', url: 'https://branta-deploy.vercel.app/', tags: ['6 Parts', '17 Sections'], sections: ['number_theory'], totalSections: 17, progressPrefix: 'branta:', leaderboardUrl: 'https://branta-deploy.vercel.app/#/leaderboard', shortName: 'Branta', progressGradient: 'linear-gradient(90deg, #f59e0b, #d97706)' },
  { id: 'ln-bolts', title: 'Lightning Network BOLTs', description: 'The complete Basis of Lightning Technology specifications. From encrypted transport to payment encoding, master the protocol that enables instant Bitcoin payments.', icon: '⚡', url: 'https://ln-bolts-deploy.vercel.app/', tags: ['8 Parts', '23 Sections'], sections: ['featured', 'number_theory'], totalSections: 23, progressPrefix: 'ln-bolts:', leaderboardUrl: 'https://ln-bolts-deploy.vercel.app/#/leaderboard', shortName: 'LN BOLTs', progressGradient: 'linear-gradient(90deg, #f59e0b, #fbbf24)' },
  { id: 'nostr-nips', title: 'Nostr Protocol (NIPs)', description: 'Master the Nostr protocol through its NIPs (Nostr Implementation Possibilities) - from core protocol to advanced applications.', icon: '🟣', url: 'https://nostr-nips-deploy.vercel.app/', tags: ['10 Parts', '78 Sections'], sections: ['featured', 'number_theory'], totalSections: 78, progressPrefix: 'nostr-nips:', leaderboardUrl: 'https://nostr-nips-deploy.vercel.app/#/leaderboard', shortName: 'Nostr NIPs', progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)' },
  ...
  { id: 'zeus', title: 'Zeus Lightning Wallet', description: 'Master the Zeus mobile wallet for Bitcoin and Lightning Network. From embedded nodes to channel management, learn self-custodial Lightning payments with the most powerful mobile wallet.', icon: '⚡', url: 'https://zeus-deploy.vercel.app/', tags: ['4 Parts', '10 Sections'], sections: ['featured', 'number_theory'], totalSections: 10, progressPrefix: 'zeus:', leaderboardUrl: 'https://zeus-deploy.vercel.app/#/leaderboard', shortName: 'Zeus Wallet', progressGradient: 'linear-gradient(90deg, #f59e0b, #fbbf24)' },
