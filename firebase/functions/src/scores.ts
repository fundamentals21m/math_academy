...
type CourseId = 'ba' | 'crypto' | 'aa' | 'linalg' | 'advlinalg' | 'islr' | 'ra' | 'calc1' | 'calc_lib_art' | 'men_of_math' | 'calc_easy' | 'wm' | 'four_pillars' | 'mom';
...
export const syncScores = functions.https.onCall(
  async (
    ...
    const validCourses: CourseId[] = ['ba', 'crypto', 'aa', 'linalg', 'advlinalg', 'islr', 'ra', 'calc1', 'calc_lib_art', 'men_of_math', 'calc_easy', 'wm', 'four_pillars', 'mom'];
    const batch = admin.firestore().batch();
    const userScores: Record<CourseId, number> = { ba: 0, crypto: 0, aa: 0, linalg: 0, advlinalg: 0, islr: 0, ra: 0, calc1: 0, calc_lib_art: 0, men_of_math: 0, calc_easy: 0, wm: 0, four_pillars: 0, mom: 0 };
...
export const getLeaderboard = functions.https.onCall(
  async (
    ...
    const validOptions = ['ba', 'crypto', 'aa', 'linalg', 'advlinalg', 'islr', 'ra', 'calc1', 'calc_lib_art', 'men_of_math', 'calc_easy', 'wm', 'four_pillars', 'mom', 'overall'];
...
export const getUserScores = functions.https.onCall(
  async (
    ...
    return {
      found: true,
      scores: userData.scores || { ba: 0, crypto: 0, aa: 0, linalg: 0, advlinalg: 0, islr: 0, ra: 0, calc1: 0, calc_lib_art: 0, men_of_math: 0, calc_easy: 0, wm: 0, four_pillars: 0, mom: 0 },
