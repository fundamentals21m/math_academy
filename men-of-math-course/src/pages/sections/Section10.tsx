...
export default function Section10() {
  return (
    <LessonLayout sectionId={10}>
      ...
      <Callout type="success">
        <p>
          <strong>Why So Beautiful?</strong> Euler's identity <MathInline>e^{'{i\\pi}'} + 1 = 0</MathInline> contains:
      ...
      <CardGrid>
        <Card>
          ...
          <p className="text-sm text-dark-300">
            ...
            number theory and RSA encryption: <MathInline>a^{'{\\varphi(n)}'} \equiv 1 \pmod n</MathInline>
          </p>
        </Card>
        <Card>
      ...
      <div className="bg-dark-800 rounded-lg p-6">
        <ul className="space-y-3">
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              Euler's formula <MathInline>e^{'{i\\theta}'} = \cos\theta + i\sin\theta</MathInline> and
              identity <MathInline>e^{'{i\\pi}'} + 1 = 0</MathInline> connect the five most important
