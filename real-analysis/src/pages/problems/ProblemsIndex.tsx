      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400">
            Practice problems and worked examples for Introduction to Real Analysis
          </p>
        </motion.div>
        ...
        >
          ...
          <ul className="text-sm text-dark-400 space-y-1">
            <li>
              <span className="text-amber-400">Examples</span> are worked problems with detailed solutions
            </li>
            <li>
              <span className="text-emerald-400">Exercises</span> are practice problems with step-by-step solutions
            </li>
