...
export const section14Quiz = {
  easy: [
    ...
    },
    {
      id: 's14-e05',
      type: 'numeric',
      question: 'Using FTC, evaluate $\\int_0^2 3x^2\\,dx$.',
      correctAnswer: 8,
      difficulty: 'easy',
      explanation: 'Antiderivative is $x^3$. Evaluate: $2^3 - 0^3 = 8$.'
    },
    {
      id: 's14-e06',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-e08',
      type: 'numeric',
      question: 'Using FTC, $\\int_1^4 \\frac{1}{2\\sqrt{x}}\\,dx = $?',
      correctAnswer: 1,
      difficulty: 'easy',
      explanation: 'Antiderivative of $\\frac{1}{2\\sqrt{x}}$ is $\\sqrt{x}$. Evaluate: $\\sqrt{4} - \\sqrt{1} = 2 - 1 = 1$.'
    },
    {
      id: 's14-e09',
      type: 'multiple-choice',
      question: 'The function $F(x) = \\int_0^x \\sin t\\,dt$ is:',
      options: [
        '$\\sin x$',
        '$\\cos x$',
        '$-\\cos x$',
      ...
      correctIndex: 3,
      difficulty: 'easy',
      explanation: '$\\int_0^x \\sin t\\,dt = [-\\cos t]_0^x = -\\cos x + \\cos 0 = 1 - \\cos x$.'
    },
    {
      id: 's14-e10',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-e11',
      type: 'numeric',
      question: 'Evaluate $\\int_0^1 e^x\\,dx$. Round to 2 decimals.',
      correctAnswer: 1.72,
      numericRange: { min: 1.71, max: 1.73 },
      difficulty: 'easy',
      explanation: '$[e^x]_0^1 = e - 1 \\approx 1.718$.'
    },
    {
      id: 's14-e12',
      type: 'multiple-choice',
    ...
    },
    {
      ...
      correctAnswer: 0,
      difficulty: 'easy',
      explanation: '$[\\sin x]_0^{\\pi} = \\sin\\pi - \\sin 0 = 0 - 0 = 0$.'
    },
    {
      id: 's14-e14',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-e18',
      type: 'multiple-choice',
      question: 'An antiderivative of the constant function $f(x) = 5$ is:',
      options: [
        '$5$',
        '$5x$',
        '$x^5$',
      ...
      correctIndex: 1,
      difficulty: 'easy',
      explanation: '$\\frac{d}{dx}(5x) = 5$, so $5x$ is an antiderivative.'
    },
    {
      id: 's14-e19',
      type: 'numeric',
      question: 'Evaluate $\\int_0^3 2\\,dx$.',
      correctAnswer: 6,
      difficulty: 'easy',
      explanation: '$[2x]_0^3 = 6 - 0 = 6$.'
    },
    {
      id: 's14-e20',
      type: 'multiple-choice',
  ...
  medium: [
    ...
    },
    {
      id: 's14-m04',
      type: 'numeric',
      question: 'Evaluate $\\int_0^1 x e^{x^2}\\,dx$. Round to 2 decimals.',
      correctAnswer: 0.86,
      numericRange: { min: 0.85, max: 0.87 },
      difficulty: 'medium',
      explanation: 'Substitution $u = x^2$: $\\frac{1}{2}[e^{x^2}]_0^1 = \\frac{e-1}{2} \\approx 0.859$.'
    },
    {
      id: 's14-m05',
      type: 'multiple-choice',
      question: 'The function $F(x) = \\int_0^x \\text{sgn}(t)\\,dt$ where sgn is the sign function:',
      options: [
        'Is differentiable everywhere',
        'Is differentiable except at $x = 0$',
        'Equals $|x|$',
        'Is not continuous'
      ],
      correctIndex: 2,
      difficulty: 'medium',
      explanation: '$F(x) = |x|$. It is continuous but not differentiable at $0$.'
    },
    {
      id: 's14-m06',
      type: 'multiple-choice',
      question: 'The condition "$F\' = f$ on $[a,b]$" in FTC II means:',
      options: [
        '$F\'$ exists and equals $f$ at every point of $[a,b]$',
        '$f$ is differentiable',
        '$F$ is integrable',
        '$F$ is continuous on $[a,b]$ and $F\' = f$ on $(a,b)$'
      ],
      correctIndex: 3,
      difficulty: 'medium',
      explanation: 'Standard FTC II: $F$ continuous on $[a,b]$, $F\' = f$ on the open interval.'
    },
    {
      id: 's14-m07',
      type: 'numeric',
      question: 'Evaluate $\\int_1^2 \\frac{x^2 + 1}{x}\\,dx$. Round to 2 decimals.',
      correctAnswer: 2.19,
      numericRange: { min: 2.18, max: 2.20 },
      difficulty: 'medium',
      explanation: '$\\int (x + 1/x)\\,dx = [\\frac{x^2}{2} + \\ln x]_1^2 = (2 + \\ln 2) - (0.5 + 0) \\approx 2.19$.'
    },
    {
      id: 's14-m08',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-m10',
      type: 'numeric',
      question: 'Let $F(x) = \\int_0^x \\cos(t^2)\\,dt$. Find $F\'(0)$.',
      correctAnswer: 1,
      difficulty: 'medium',
      explanation: 'By FTC I, $F\'(x) = \\cos(x^2)$, so $F\'(0) = \\cos(0) = 1$.'
    },
    {
      id: 's14-m11',
      type: 'multiple-choice',
      question: 'If $f$ is integrable but not continuous at $c \\in (a,b)$, then $F(x) = \\int_a^x f$:',
      options: [
        'Is not differentiable at $c$',
        'Is always differentiable at $c$',
        'May or may not be differentiable at $c$',
        'Is discontinuous at $c$'
      ],
      correctIndex: 2,
      difficulty: 'medium',
      explanation: '$F$ is always continuous, but differentiability at discontinuity of $f$ requires analysis.'
    },
    {
      id: 's14-m12',
      type: 'numeric',
      question: 'Evaluate $\\int_0^{\\pi/4} \\sec^2 x\\,dx$.',
      correctAnswer: 1,
      difficulty: 'medium',
      explanation: '$[\\tan x]_0^{\\pi/4} = \\tan(\\pi/4) - \\tan(0) = 1 - 0 = 1$.'
    },
    {
      id: 's14-m13',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-m15',
      type: 'numeric',
      question: 'Evaluate $\\int_0^1 \\frac{2x}{1+x^2}\\,dx$. Round to 2 decimals.',
      correctAnswer: 0.69,
      numericRange: { min: 0.68, max: 0.70 },
      difficulty: 'medium',
      explanation: '$[\\ln(1+x^2)]_0^1 = \\ln 2 - \\ln 1 = \\ln 2 \\approx 0.693$.'
    },
    {
      id: 's14-m16',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-m17',
      type: 'numeric',
      question: 'Evaluate $\\int_0^2 |x-1|\\,dx$.',
      correctAnswer: 1,
      difficulty: 'medium',
      explanation: 'Split at $x=1$: $\\int_0^1 (1-x)\\,dx + \\int_1^2 (x-1)\\,dx = 0.5 + 0.5 = 1$.'
    },
    {
      id: 's14-m18',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-m20',
      type: 'numeric',
      question: 'If $F(x) = \\int_1^x \\ln t\\,dt$, find $F(e)$. Round to 2 decimals.',
      correctAnswer: 1,
      difficulty: 'medium',
      explanation: '$\\int \\ln t\\,dt = t\\ln t - t$. Evaluate: $(e - e) - (0 - 1) = 1$.'
    }
  ] as QuizQuestion[],
  ...
  hard: [
    {
      id: 's14-h01',
      type: 'multiple-choice',
      question: 'The most general form of FTC II requires:',
      options: [
        '$F$ absolutely continuous on $[a,b]$',
      ...
      correctIndex: 0,
      difficulty: 'hard',
      explanation: 'Lebesgue\'s theorem: $\\int_a^b F\' = F(b) - F(a)$ holds for absolutely continuous $F$.'
    },
    {
      id: 's14-h02',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-h05',
      type: 'numeric',
      question: 'Evaluate $\\int_0^1 x^2 e^x\\,dx$ using integration by parts twice. Round to 2 decimals.',
      correctAnswer: 0.72,
      numericRange: { min: 0.71, max: 0.73 },
      difficulty: 'hard',
      explanation: '$\\int x^2 e^x = x^2 e^x - 2xe^x + 2e^x$. Evaluate: $(e - 2e + 2e) - (2) = e - 2 \\approx 0.718$.'
    },
    {
      id: 's14-h06',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-h09',
      type: 'numeric',
      question: 'Evaluate $\\int_0^{\\pi/2} \\sin^2 x\\,dx$. Give exact value as decimal.',
      correctAnswer: 0.785,
      numericRange: { min: 0.78, max: 0.79 },
      difficulty: 'hard',
      explanation: '$\\sin^2 x = (1-\\cos 2x)/2$. Integral: $[x/2 - \\sin 2x/4]_0^{\\pi/2} = \\pi/4 \\approx 0.785$.'
    },
    {
      id: 's14-h10',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-h12',
      type: 'numeric',
      question: 'Evaluate $\\int_0^1 \\arctan x\\,dx$. Round to 3 decimals.',
      correctAnswer: 0.439,
      numericRange: { min: 0.438, max: 0.440 },
      difficulty: 'hard',
      explanation: 'By parts: $[x\\arctan x - \\frac{1}{2}\\ln(1+x^2)]_0^1 = \\pi/4 - \\ln 2/2 \\approx 0.439$.'
    },
    {
      id: 's14-h13',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-h15',
      type: 'numeric',
      question: 'Evaluate $\\int_0^1 \\frac{\\ln(1+x)}{x}\\,dx$ using power series. Round to 2 decimals.',
      correctAnswer: 0.82,
      numericRange: { min: 0.81, max: 0.83 },
      difficulty: 'hard',
      explanation: '$\\ln(1+x)/x = \\sum_{n=0}^\\infty \\frac{(-1)^n x^n}{n+1}$. Integral: $\\sum \\frac{(-1)^n}{(n+1)^2} = \\pi^2/12 \\approx 0.822$.'
    },
    {
      id: 's14-h16',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's14-h18',
      type: 'numeric',
      question: 'If $F(x) = \\int_0^x \\sin(t^2)\\,dt$ (Fresnel integral), find $F\'(\\sqrt{\\pi/2})$. Round to 2 decimals.',
      correctAnswer: 1,
      difficulty: 'hard',
      explanation: '$F\'(x) = \\sin(x^2)$. At $x = \\sqrt{\\pi/2}$: $\\sin(\\pi/2) = 1$.'
    },
    {
      id: 's14-h19',
      type: 'multiple-choice',
