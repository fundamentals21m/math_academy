...
export const section06Quiz = {
  easy: [
    ...
    },
    {
      ...
      options: ['$1$', '$\\infty$', 'Can be any value', '$0$'],
      correctIndex: 3,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Diverges', 'Converges', 'Converges conditionally', 'Cannot be determined'],
      correctIndex: 0,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Diverges', 'Oscillates', 'Converges', 'Equals $1$'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Diverges', 'Converges to $0$', 'Converges to $c \\cdot \\sum a_n$', 'Depends on $c$'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Converges to $\\infty$', 'Converges to $1$', 'Equals $e$', 'Diverges'],
      correctIndex: 3,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Diverges', 'Converges', 'Converges conditionally', 'May not exist'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Convergent', 'Absolutely convergent', 'Divergent', 'Conditionally convergent'],
      correctIndex: 2,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['Converges', 'Converges to $2$', 'Diverges', 'Converges conditionally'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Diverges', 'Converges', 'Converges to $e$', 'Converges to $\\ln 2$'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Diverges', 'Converges to $2$', 'Converges to $1$', 'Converges to $4$'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['$\\ln(1+x)$', '$\\sin x$', '$e^x$', '$\\cos x$'],
      correctIndex: 2,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['$s > 0$', '$s \\geq 1$', 'All real $s$', '$s > 1$'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['$S$', '$S/2$', '$2S$', 'Cannot be determined'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Converges to $1$', 'Diverges', 'Converges to $2$', 'Converges to $\\pi^2/6$'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Converges', 'Diverges', 'Oscillates', 'Converges to $e$'],
      correctIndex: 0,
      difficulty: 'hard',
