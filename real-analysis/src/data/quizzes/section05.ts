...
export const section05Quiz = {
  easy: [
    ...
    },
    {
      ...
      options: ['$1$', '$\\infty$', '$0$', 'Does not exist'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      correctAnswer: 1,
      difficulty: 'easy',
      explanation: 'Divide numerator and denominator by $n$: $\\frac{n}{n+1} = \\frac{1}{1 + 1/n} \\to \\frac{1}{1+0} = 1$.'
    },
    {
      id: 's05-e09',
      type: 'multiple-choice',
      question: 'Every convergent sequence is:',
      options: ['Unbounded', 'Bounded', 'Monotonic', 'Strictly increasing'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      id: 's05-e14',
      type: 'numeric',
      question: 'What is $\\lim_{n \\to \\infty} \\frac{3n + 1}{n}$?',
      correctAnswer: 3,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Diverges', 'Is unbounded', 'Converges', 'Oscillates'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['$L < 0$', '$L \\geq 0$', '$L = 0$', '$L$ can be any real number'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      id: 's05-e20',
      type: 'numeric',
      question: 'What is $\\lim_{n \\to \\infty} \\frac{5}{n}$?',
      correctAnswer: 0,
      difficulty: 'easy',
      explanation: 'As $n \\to \\infty$, $5/n \\to 0$.'
    }
  ] as QuizQuestion[],
  ...
  medium: [
    ...
    },
    {
      id: 's05-m06',
      type: 'numeric',
      question: 'What is $\\lim_{n \\to \\infty} \\frac{3n^2 + n}{n^2 + 1}$?',
      correctAnswer: 3,
      difficulty: 'medium',
      explanation: 'Divide by $n^2$: $\\frac{3 + 1/n}{1 + 1/n^2} \\to \\frac{3}{1} = 3$.'
    },
    {
      id: 's05-m07',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's05-m12',
      type: 'numeric',
      question: 'If $a_n = \\frac{2n + 3}{n + 1}$, what is $\\lim_{n \\to \\infty} a_n$?',
      correctAnswer: 2,
      difficulty: 'medium',
      explanation: 'Divide by $n$: $\\frac{2 + 3/n}{1 + 1/n} \\to \\frac{2}{1} = 2$.'
    },
    {
      id: 's05-m13',
      type: 'multiple-choice',
    ...
    },
    {
      ...
      options: ['$0$', '$\\infty$', 'Does not exist', 'Depends on $b_n$'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      id: 's05-m18',
      type: 'numeric',
      question: 'What is $\\lim_{n \\to \\infty} \\frac{n^3}{n^3 + n^2 + n + 1}$?',
      correctAnswer: 1,
      difficulty: 'medium',
      explanation: 'Divide by $n^3$: $\\frac{1}{1 + 1/n + 1/n^2 + 1/n^3} \\to 1$.'
    },
    {
      id: 's05-m19',
      type: 'multiple-choice',
  ...
  hard: [
    ...
    },
    {
      id: 's05-h08',
      type: 'numeric',
      question: 'If $a_n = \\frac{2^n}{n!}$, what is $\\lim_{n \\to \\infty} a_n$?',
      correctAnswer: 0,
      difficulty: 'hard',
      explanation: 'For $n > 2$, $\\frac{a_{n+1}}{a_n} = \\frac{2}{n+1} < 1$. The sequence decreases to $0$ since factorial grows faster than exponential.'
    },
    {
      id: 's05-h09',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's05-h18',
      type: 'numeric',
      question: 'What is $\\lim_{n \\to \\infty} \\left(1 + \\frac{2}{n}\\right)^n$? (Round to 1 decimal place)',
      correctAnswer: 7.4,
      numericRange: { min: 7, max: 8 },
      difficulty: 'hard',
      explanation: '$\\left(1 + \\frac{2}{n}\\right)^n \\to e^2 \\approx 7.389$.'
    },
    {
      id: 's05-h19',
      type: 'multiple-choice',
