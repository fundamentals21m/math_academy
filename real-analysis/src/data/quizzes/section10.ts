...
export const section10Quiz = {
  easy: [
    ...
    },
    {
      id: 's10-e02',
      type: 'multiple-choice',
      question: 'The Extreme Value Theorem states that if $f$ is continuous on $[a,b]$, then:',
      options: [
        '$f$ is differentiable on $(a,b)$',
        '$f$ attains its maximum and minimum on $[a,b]$',
        '$f$ is constant',
        '$f(a) = f(b)$'
      ],
      correctIndex: 1,
      difficulty: 'easy',
      explanation: 'Continuous functions on closed bounded intervals attain their supremum and infimum.'
    },
    {
      id: 's10-e03',
      type: 'multiple-choice',
      ...
      correctIndex: 1,
      difficulty: 'easy',
      explanation: 'Continuous functions on compact sets are bounded (and attain their bounds).'
    },
    {
      id: 's10-e04',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's10-e08',
      type: 'numeric',
      question: 'If $f(x) = x^3 - x$ on $[-2, 2]$, what is $f(-2)$?',
      correctAnswer: -6,
      difficulty: 'easy',
      explanation: '$f(-2) = (-2)^3 - (-2) = -8 + 2 = -6$.'
    },
    {
      id: 's10-e09',
      type: 'multiple-choice',
    ...
    },
    {
      ...
      options: ['$x = 0$', '$x = \\pi/2$', '$x = \\pi$', '$x = 2\\pi$'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      id: 's10-e16',
      type: 'numeric',
      question: 'For $f(x) = x^2 - 4$ on $[0, 3]$, the minimum value is:',
      correctAnswer: -4,
      difficulty: 'easy',
      explanation: '$f(0) = -4$, $f(3) = 5$. The vertex is at $x = 0$ with value $-4$.'
    },
    {
      id: 's10-e17',
      type: 'multiple-choice',
  ...
  medium: [
    ...
    },
    {
      id: 's10-m06',
      type: 'numeric',
      question: 'For $f(x) = x^3 - 3x$ on $[-2, 2]$, the maximum value is:',
      correctAnswer: 2,
      difficulty: 'medium',
      explanation: 'Critical points: $f\'(x) = 3x^2 - 3 = 0$ gives $x = \\pm 1$. $f(-1) = 2$, $f(1) = -2$, $f(-2) = -2$, $f(2) = 2$. Max is $2$.'
    },
    {
      id: 's10-m07',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's10-m13',
      type: 'multiple-choice',
      question: 'The Bolzano theorem is a special case of:',
      options: [
      ...
      correctIndex: 1,
      difficulty: 'medium',
      explanation: 'Bolzano\'s theorem (root existence) is IVT for $k = 0$.'
    },
    {
      id: 's10-m14',
      type: 'numeric',
      question: 'For $f(x) = |x - 1|$ on $[0, 3]$, the minimum value is:',
      correctAnswer: 0,
      difficulty: 'medium',
      explanation: '$f$ has minimum $0$ at $x = 1$.'
    },
    {
      id: 's10-m15',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's10-m17',
      type: 'multiple-choice',
      question: 'The function $f(x) = x^2$ maps $(0,1)$ to:',
      options: ['$(0,1)$', '$[0,1]$', '$(0,1]$', '$[0,1)$'],
      correctIndex: 0,
      difficulty: 'medium',
      explanation: '$x \\in (0,1)$ implies $x^2 \\in (0,1)$. Neither $0$ nor $1$ is achieved.'
    },
    {
      id: 's10-m18',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's10-m20',
      type: 'numeric',
      question: 'The equation $\\cos x = x$ has how many solutions in $[0, \\pi]$?',
      correctAnswer: 1,
      difficulty: 'medium',
      explanation: 'Let $f(x) = \\cos x - x$. $f(0) = 1 > 0$, $f(\\pi) = -1 - \\pi < 0$. By IVT, at least one root. $f$ is strictly decreasing, so exactly one.'
    }
  ] as QuizQuestion[],
  ...
  hard: [
    ...
    },
    {
      id: 's10-h08',
      type: 'numeric',
      question: 'The equation $e^x = 3x$ has at least how many positive solutions?',
      correctAnswer: 1,
      difficulty: 'hard',
      explanation: 'Let $f(x) = e^x - 3x$. $f(0) = 1 > 0$, $f(1) = e - 3 < 0$. By IVT, at least one root in $(0,1)$. Checking further: $f(2) = e^2 - 6 > 0$, so another root in $(1,2)$. Answer: at least 1 (in the given range).'
    },
    {
      id: 's10-h09',
      type: 'multiple-choice',
    ...
    },
    {
      ...
      correctIndex: 1,
      difficulty: 'hard',
      explanation: 'On $\\mathbb{R}$, continuous injective implies strictly monotonic (otherwise IVT gives repeated values).'
    },
    {
      id: 's10-h11',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's10-h16',
      type: 'numeric',
      question: 'How many real solutions does $x^3 - 3x + 1 = 0$ have?',
      correctAnswer: 3,
      difficulty: 'hard',
      explanation: 'Let $f(x) = x^3 - 3x + 1$. $f(-2) = -1$, $f(0) = 1$, $f(2) = 3$. Also $f\' = 3x^2 - 3 = 0$ at $x = \\pm 1$: $f(-1) = 3$, $f(1) = -1$. Sign changes at $(-2,-1)$, $(-1,1)$, and... no, $f(2) = 3 > 0$. Check $f(1) = -1 < 0$, $f(2) = 3 > 0$. So roots in $(-2,-1)$, $(0,1)$, $(1,2)$: 3 roots.'
    },
    {
      id: 's10-h17',
      type: 'multiple-choice',
