...
export const section13Quiz = {
  easy: [
    ...
    },
    {
      ...
      correctIndex: 2,
      difficulty: 'easy',
      explanation: 'Monotonic functions have at most countably many discontinuities, so they\'re integrable.'
    },
    {
      id: 's13-e07',
      type: 'numeric',
      question: 'For $f(x) = 2$ on $[0, 3]$, what is $\\int_0^3 f(x)\\,dx$?',
      correctAnswer: 6,
      difficulty: 'easy',
      explanation: 'Area of rectangle: $2 \\times 3 = 6$.'
    },
    {
      id: 's13-e08',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's13-e14',
      type: 'numeric',
      question: 'For $f(x) = x$ on $[0, 2]$, what is $\\int_0^2 x\\,dx$?',
      correctAnswer: 2,
      difficulty: 'easy',
      explanation: 'Area of triangle: $\\frac{1}{2} \\times 2 \\times 2 = 2$.'
    },
    {
      id: 's13-e15',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's13-e20',
      type: 'numeric',
      question: 'For $f(x) = 3$ on $[1, 4]$, what is $\\int_1^4 3\\,dx$?',
      correctAnswer: 9,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      id: 's13-m03',
      type: 'multiple-choice',
      question: 'If $f$ is bounded with finitely many discontinuities on $[a,b]$:',
      options: [
        '$f$ is not integrable',
    ...
    },
    {
      id: 's13-m05',
      type: 'numeric',
      question: 'For $f(x) = x^2$ on $[0, 1]$, $\\int_0^1 x^2\\,dx = $?',
      correctAnswer: 0.333,
      numericRange: { min: 0.33, max: 0.34 },
      difficulty: 'medium',
      explanation: '$\\int_0^1 x^2\\,dx = [x^3/3]_0^1 = 1/3 \\approx 0.333$.'
    },
    {
      id: 's13-m06',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's13-m11',
      type: 'numeric',
      question: 'Calculate $\\int_0^{\\pi} \\sin x\\,dx$.',
      correctAnswer: 2,
      difficulty: 'medium',
    ...
    },
    {
      id: 's13-m20',
      type: 'numeric',
      question: 'Calculate $\\int_0^1 e^x\\,dx$ to 2 decimal places.',
      correctAnswer: 1.72,
  ...
  hard: [
    ...
    },
    {
      ...
      correctIndex: 0,
      difficulty: 'hard',
      explanation: 'E.g., the Thomae function is discontinuous on rationals (dense, measure zero).'
    },
    {
      id: 's13-h04',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's13-h07',
      type: 'numeric',
      question: 'Calculate $\\int_0^1 x e^x\\,dx$ using integration by parts. Round to 2 decimals.',
      correctAnswer: 1,
      difficulty: 'hard',
      explanation: '$\\int xe^x = xe^x - e^x$. Evaluated: $(e-e) - (0-1) = 0 + 1 = 1$.'
    },
    {
      id: 's13-h08',
      type: 'multiple-choice',
    ...
    },
    {
      ...
      correctIndex: 1,
      difficulty: 'hard',
      explanation: 'Volterra\'s example: bounded derivative discontinuous on a fat Cantor set, still integrable.'
    },
    {
      id: 's13-h12',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's13-h13',
      type: 'numeric',
      question: 'Calculate $\\int_0^{\\pi/2} \\cos^2 x\\,dx$.',
      correctAnswer: 0.785,
      numericRange: { min: 0.78, max: 0.79 },
      difficulty: 'hard',
      explanation: '$\\cos^2 x = (1 + \\cos 2x)/2$. Integral is $\\frac{1}{2}[x + \\frac{\\sin 2x}{2}]_0^{\\pi/2} = \\frac{\\pi}{4} \\approx 0.785$.'
    },
    {
      id: 's13-h14',
      type: 'multiple-choice',
    ...
    },
    {
      id: 's13-h18',
      type: 'numeric',
      question: 'Calculate $\\int_0^1 \\frac{1}{1+x^2}\\,dx$ to 3 decimals.',
      correctAnswer: 0.785,
      numericRange: { min: 0.78, max: 0.79 },
      difficulty: 'hard',
      explanation: '$[\\arctan x]_0^1 = \\pi/4 - 0 = \\pi/4 \\approx 0.785$.'
    },
    {
      id: 's13-h19',
      type: 'multiple-choice',
