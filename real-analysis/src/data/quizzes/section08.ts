...
export const section08Quiz = {
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['$\\frac{1}{1-x^2}$', '$\\cos x$', '$\\frac{1}{1+x^2}$', '$e^{-x^2}$'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['$\\sin x$', '$\\cosh x$', '$\\cos x$', '$e^x$'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['$\\sin x$', '$\\cos x$', '$\\sinh x$', '$e^x$'],
      correctIndex: 2,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['$\\sin x$', '$\\cos x$', '$\\ln(1+x)$', '$\\arctan x$'],
      correctIndex: 3,
      difficulty: 'hard',
