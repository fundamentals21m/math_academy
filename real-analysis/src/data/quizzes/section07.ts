...
export const section07Quiz = {
  easy: [
    ...
    },
    {
      ...
      options: ['Integral test', 'Ratio test', 'Root test', 'Comparison with harmonic'],
      correctIndex: 0,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Diverges', 'Is inconclusive', 'Oscillates', 'Converges'],
      correctIndex: 3,
      difficulty: 'easy',
  ...
  medium: [
    {
      ...
      options: ['Diverges', 'Is inconclusive', 'Converges', 'Converges conditionally'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Converges', 'Oscillates', 'Cannot be determined', 'Diverges'],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Converges', 'Is inconclusive', 'Converges absolutely', 'Diverges'],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Converges to $e^2 - 1$', 'Diverges', 'Converges to $e^2$', 'Converges to $2$'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Diverges', 'Is conditionally convergent', 'Oscillates', 'Converges'],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Diverges', 'Converges', 'Cannot be determined', 'Converges conditionally'],
      correctIndex: 0,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['$p > 1$', '$p > 0$', '$p \\geq 1$', '$p \\geq 2$'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Converges', 'Diverges', 'Oscillates', 'Converges to $\\pi$'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Diverges', 'Converges to $\\pi$', 'Oscillates', 'Converges'],
      correctIndex: 3,
      difficulty: 'hard',
