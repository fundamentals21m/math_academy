 ...
 */
export const COURSE_ID: CourseId = 'dh-taleb';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Dynamic Hedging';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'Managing Vanilla and Exotic Options - Based on Nassim Taleb';
