...
import { MasteryIndicator } from '../gamification';
...
/**
 * Shared sidebar navigation component for all courses.
 * Displays curriculum structure with collapsible parts and sections.
 *
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  const { id: courseId, features, curriculum } = useCourseConfig();
  ...
  const getMasteryLevel = (sectionId: number) => {
    ...
    const id = `${courseId}:${sectionId}` as const;
