...
import type { AchievementNotification } from '@shared/gamification/types';
...
/**
 * Individual achievement notification toast.
 ...
 * />
 */
export function AchievementToastContainer({ notifications, onDismiss }: AchievementToastContainerProps) {
  return (
