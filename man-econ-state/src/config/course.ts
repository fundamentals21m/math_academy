 ...
 */
export const COURSE_ID = 'man_econ_state' as CourseId;

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Man, Economy, and State';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = "Murray Rothbard's treatise on economics - a comprehensive exposition of Austrian Economics";
