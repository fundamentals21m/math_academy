...
/**
 * Difficulty tier for racing game (1-6)
 */
export type RacingTier = 1 | 2 | 3 | 4 | 5 | 6;
...
export const RACING_TIERS: RacingTierConfig[] = [
  { tier: 1, name: 'Beginner',     unlockLevel: 1, modulusRange: [2, 5],   dividendRange: [10, 25],   timeLimitSeconds: 10, basePoints: 50 },
  { tier: 2, name: 'Novice',       unlockLevel: 2, modulusRange: [2, 7],   dividendRange: [15, 50],   timeLimitSeconds: 8,  basePoints: 75 },
  { tier: 3, name: 'Intermediate', unlockLevel: 3, modulusRange: [3, 10],  dividendRange: [20, 100],  timeLimitSeconds: 7,  basePoints: 100 },
  { tier: 4, name: 'Advanced',     unlockLevel: 5, modulusRange: [5, 13],  dividendRange: [50, 200],  timeLimitSeconds: 6,  basePoints: 150 },
  { tier: 5, name: 'Expert',       unlockLevel: 7, modulusRange: [7, 17],  dividendRange: [100, 500], timeLimitSeconds: 5,  basePoints: 200 },
  { tier: 6, name: 'Master',       unlockLevel: 9, modulusRange: [11, 23], dividendRange: [200, 999], timeLimitSeconds: 4,  basePoints: 300 },
];
