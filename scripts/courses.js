...
export const COURSES = [
  ...
  },
  {
    ...
    icon: '🔐',
    url: 'https://frost-deploy.vercel.app/',
    tags: ['10 Parts', '69 Sections'],
    sections: ['featured', 'number_theory'],
    totalSections: 69,
    progressPrefix: 'frost:',
    leaderboardUrl: 'https://frost-deploy.vercel.app/#/leaderboard',
    shortName: 'FROST',
    progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)',
  },
  {
    ...
    icon: '📊',
    url: 'https://islr-deploy.vercel.app/',
    tags: ['13 Chapters', '62 Sections'],
    sections: ['prob_stats'],
    totalSections: 62,
    progressPrefix: 'islr:',
    leaderboardUrl: 'https://islr-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    description: 'A comprehensive course covering 100+ Bitcoin Improvement Proposals. From BIP-1 governance to Taproot, Schnorr signatures, PSBTs, and Layer 2 protocols.',
    icon: '📜',
    url: 'https://bips-deploy.vercel.app/',
    tags: ['8 Parts', '95 Sections'],
    sections: ['featured', 'number_theory'],
    totalSections: 95,
    progressPrefix: 'bips:',
    leaderboardUrl: 'https://bips-deploy.vercel.app/#/leaderboard',
    shortName: 'BIPs',
    progressGradient: 'linear-gradient(90deg, #f97316, #fbbf24)',
  },
  ...
  // BEGINNERS
  {
    ...
    icon: '∂',
    url: 'https://calceasy-deploy.vercel.app/',
    tags: ['26 Sections', 'Interactive'],
    sections: ['beginners', 'calculus'],
    totalSections: 26,
    progressPrefix: 'calc_easy:',
    leaderboardUrl: 'https://calceasy-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: 'x²',
    url: 'https://basic-algebra-deploy.vercel.app/',
    tags: ['17 Chapters', '64 Sections'],
    sections: ['beginners', 'algebra'],
    totalSections: 64,
    progressPrefix: 'ba:',
    leaderboardUrl: 'https://basic-algebra-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: '📚',
    url: 'https://why-math-deploy.vercel.app/',
    tags: ['8 Parts', '13 Sections'],
    sections: ['beginners'],
    totalSections: 13,
    progressPrefix: 'wm:',
    leaderboardUrl: 'https://why-math-deploy.vercel.app/#/leaderboard',
    shortName: 'Why Math?',
    progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)',
  },
  ...
  // CALCULUS
  {
    ...
    icon: '∫',
    url: 'https://calc1-deploy.vercel.app/',
    tags: ['17 Parts', '101 Sections'],
    sections: ['calculus'],
    totalSections: 101,
    progressPrefix: 'calc1:',
    leaderboardUrl: 'https://calc1-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    description: "Multi-variable calculus and linear algebra with applications to differential equations and probability. Based on Tom M. Apostol's Calculus, Volume II.",
    icon: '∫∫',
    url: 'https://calc2-deploy.vercel.app/',
    tags: ['15 Parts', '191 Sections'],
    sections: ['calculus', 'algebra'],
    totalSections: 191,
    progressPrefix: 'calc2:',
    leaderboardUrl: 'https://calc2-deploy.vercel.app/#/leaderboard',
    shortName: 'Advanced Calculus',
  ...
  },
  {
    ...
    icon: '📚',
    url: 'https://calc-lib-art-deploy.vercel.app/',
    tags: ['Interactive', 'Conceptual'],
    sections: ['calculus'],
    totalSections: 15,
    progressPrefix: 'calc_lib_art:',
    leaderboardUrl: 'https://calc-lib-art-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: '📐',
    url: 'https://ra-deploy.vercel.app/',
    tags: ['4 Parts', '15 Sections'],
    sections: ['calculus'],
    totalSections: 15,
    progressPrefix: 'ra:',
    leaderboardUrl: 'https://ra-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: 'ε',
    url: 'https://tao-analysis-1-deploy.vercel.app/',
    tags: ['13 Parts', '72 Sections'],
    sections: ['calculus', 'seminal'],
    totalSections: 72,
    progressPrefix: 'tao-analysis-1:',
    leaderboardUrl: 'https://tao-analysis-1-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: 'δ',
    url: 'https://tao2-deploy.vercel.app/',
    tags: ['8 Parts', '48 Sections'],
    sections: ['calculus', 'seminal'],
    totalSections: 48,
    progressPrefix: 'tao2:',
    leaderboardUrl: 'https://tao2-deploy.vercel.app/#/leaderboard',
    shortName: 'Tao Analysis II',
    progressGradient: 'linear-gradient(90deg, #8b5cf6, #a78bfa)',
  },
  {
    id: 'lagrange',
    title: 'Mécanique analytique (Lagrange)',
    description: 'Master analytical mechanics: Lagrangian and Hamiltonian formulations, non-inertial reference frames, and rigid body dynamics.',
    icon: '⚙️',
    url: 'https://lagrange-deploy.vercel.app/',
    tags: ['4 Parts', '21 Sections'],
    sections: ['calculus'],
    totalSections: 21,
    progressPrefix: 'lagrange:',
    leaderboardUrl: 'https://lagrange-deploy.vercel.app/#/leaderboard',
    shortName: 'Lagrange',
    progressGradient: 'linear-gradient(90deg, #f59e0b, #fbbf24)',
  },
  ...
  // ALGEBRA (Note: Basic Algebra also appears here via sections array)
  {
    ...
    url: 'https://linalg-deploy.vercel.app/',
    tags: ['Vectors & Matrices', 'Interactive'],
    sections: ['algebra'],
    totalSections: 50,
    progressPrefix: 'linalg:',
    leaderboardUrl: 'https://linalg-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: '\u2133',
    url: 'https://advlinalg-deploy.vercel.app/',
    tags: ['10 Chapters', '59 Sections'],
    sections: ['algebra'],
    totalSections: 12,
    progressPrefix: 'advlinalg:',
    leaderboardUrl: 'https://advlinalg-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: 'G',
    url: 'https://aa-deploy.vercel.app/',
    tags: ['Groups & Rings', 'Fields'],
    sections: ['algebra'],
    totalSections: 50,
    progressPrefix: 'aa:',
    leaderboardUrl: 'https://aa-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: 'G',
    url: 'https://df-deploy.vercel.app/',
    tags: ['6 Parts', '95 Sections'],
    sections: ['algebra'],
    totalSections: 95,
    progressPrefix: 'df:',
    leaderboardUrl: 'https://df-deploy.vercel.app/#/leaderboard',
  ...
  // GEOMETRY
  {
    ...
    icon: '🔺',
    url: 'https://four-pillars-deploy.vercel.app/',
    tags: ['8 Chapters', '66 Sections'],
    sections: ['geometry'],
    totalSections: 66,
    progressPrefix: 'four_pillars:',
    leaderboardUrl: 'https://four-pillars-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: '🔢',
    url: 'https://numbers-geometry-deploy.vercel.app/',
    tags: ['9 Chapters', '79 Sections'],
    sections: ['geometry'],
    totalSections: 79,
    progressPrefix: 'numbers_geometry:',
    leaderboardUrl: 'https://numbers-geometry-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: '🔢',
    url: 'https://gauss-deploy.vercel.app/',
    tags: ['7 Sections', 'Number Theory'],
    sections: ['seminal'],
    totalSections: 7,
    progressPrefix: 'gauss:',
    leaderboardUrl: 'https://gauss-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: '₿',
    url: 'https://only-the-strong-survive-deploy.vercel.app/',
    tags: ['8 Parts', '20 Sections'],
    sections: ['seminal'],
    totalSections: 20,
    progressPrefix: 'only_the_strong_survive:',
    leaderboardUrl: 'https://only-the-strong-survive-deploy.vercel.app/#/leaderboard',
  ...
  // MATH HISTORY
  {
    ...
    icon: '📜',
    url: 'https://mom-deploy.vercel.app/',
    tags: ['34 Sections', 'Interactive'],
    sections: ['history'],
    totalSections: 34,
    progressPrefix: 'mom:',
    leaderboardUrl: 'https://mom-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: '🏛️',
    url: 'https://thales-deploy.vercel.app/',
    tags: ['11 Parts', '66 Sections'],
    sections: ['history'],
    totalSections: 66,
    progressPrefix: 'thales:',
    leaderboardUrl: 'https://thales-deploy.vercel.app/#/leaderboard',
  ...
  // AUSTRIAN ECONOMICS
  {
    ...
    icon: '📖',
    url: 'https://human-action-deploy.vercel.app/',
    tags: ['8 Parts', '40 Sections'],
    sections: ['austrian'],
    totalSections: 40,
    progressPrefix: 'human_action:',
    leaderboardUrl: 'https://human-action-deploy.vercel.app/#/leaderboard',
  ...
  // DISCRETE MATHEMATICS
  {
    ...
    icon: '🕸️',
    url: 'https://west-graphs-deploy.vercel.app/',
    tags: ['8 Chapters', '28 Sections'],
    sections: ['discrete'],
    totalSections: 28,
    progressPrefix: 'west_graphs:',
    leaderboardUrl: 'https://west-graphs-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: '🔢',
    url: 'https://coding-theory-deploy.vercel.app/',
    tags: ['11 Chapters', '41 Sections'],
    sections: ['discrete'],
    totalSections: 41,
    progressPrefix: 'coding_theory:',
    leaderboardUrl: 'https://coding-theory-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    icon: '🔢',
    url: 'https://intro-discrete-deploy.vercel.app/',
    tags: ['6 Chapters', '26 Sections'],
    sections: ['discrete'],
    totalSections: 26,
    progressPrefix: 'intro-discrete:',
    leaderboardUrl: 'https://intro-discrete-deploy.vercel.app/#/leaderboard',
  ...
  // NUMBER THEORY
  {
    ...
    icon: '🔑',
    url: 'https://koblitz-course-deploy.vercel.app/',
    tags: ['3 Parts', '22 Sections'],
    sections: ['number_theory'],
    totalSections: 22,
    progressPrefix: 'koblitz:',
    leaderboardUrl: 'https://koblitz-course-deploy.vercel.app/#/leaderboard',
    shortName: 'Koblitz',
    progressGradient: 'linear-gradient(90deg, #f59e0b, #fbbf24)',
  },
  ...
  // PROBABILITY AND STATISTICS
  {
    ...
    icon: '🎲',
    url: 'https://ross-prob-deploy.vercel.app/',
    tags: ['10 Chapters', '66 Sections'],
    sections: ['prob_stats'],
    totalSections: 9,
    progressPrefix: 'ross-prob:',
    leaderboardUrl: 'https://ross-prob-deploy.vercel.app/#/leaderboard',
  ...
  {
    id: 'branta',
    title: 'Branta: Bitcoin Transaction Security',
    description: 'Learn pre-payment verification with Guardrail. Protect against address swaps, phishing, MITM attacks, and supply chain compromises.',
    icon: '🛡️',
    url: 'https://branta-deploy.vercel.app/',
    tags: ['6 Parts', '17 Sections'],
    sections: ['number_theory'],
    totalSections: 17,
    progressPrefix: 'branta:',
    leaderboardUrl: 'https://branta-deploy.vercel.app/#/leaderboard',
    shortName: 'Branta',
    progressGradient: 'linear-gradient(90deg, #f59e0b, #d97706)',
  },
  {
    id: 'ln-bolts',
    title: 'Lightning Network BOLTs',
    description: 'The complete Basis of Lightning Technology specifications. From encrypted transport to payment encoding, master the protocol that enables instant Bitcoin payments.',
    icon: '⚡',
    url: 'https://ln-bolts-deploy.vercel.app/',
    tags: ['8 Parts', '23 Sections'],
    sections: ['featured', 'number_theory'],
    totalSections: 23,
    progressPrefix: 'ln-bolts:',
    leaderboardUrl: 'https://ln-bolts-deploy.vercel.app/#/leaderboard',
    shortName: 'LN BOLTs',
    progressGradient: 'linear-gradient(90deg, #f59e0b, #fbbf24)',
  },
  {
    ...
    description: 'Master the Nostr protocol through its NIPs (Nostr Implementation Possibilities) - from core protocol to advanced applications.',
    icon: '🟣',
    url: 'https://nostr-nips-deploy.vercel.app/',
    tags: ['10 Parts', '78 Sections'],
    sections: ['featured', 'number_theory'],
    totalSections: 78,
    progressPrefix: 'nostr-nips:',
    leaderboardUrl: 'https://nostr-nips-deploy.vercel.app/#/leaderboard',
    shortName: 'Nostr NIPs',
    progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)',
  },
  {
    id: 'zeus',
    ...
    icon: '⚡',
    url: 'https://zeus-deploy.vercel.app/',
    tags: ['4 Parts', '10 Sections'],
    sections: ['featured', 'number_theory'],
    totalSections: 10,
    progressPrefix: 'zeus:',
    leaderboardUrl: 'https://zeus-deploy.vercel.app/#/leaderboard',
  ...
  // GAMES
  {
    ...
    icon: '🏎️',
    url: 'https://mod-race-deploy.vercel.app/',
    tags: ['10 Tiers', 'Multiplayer'],
    sections: ['games'],
    totalSections: 10,
    progressPrefix: 'mod-race:',
    leaderboardUrl: 'https://mod-race-deploy.vercel.app/#/leaderboard',
  ...
  },
  {
    ...
    description: "Master continuous-time models for quantitative finance with Shreve's classic textbook. From Brownian motion and Itô calculus to Black-Scholes, exotic options, and term structure models.",
    icon: '∫',
    url: 'https://shreve2-deploy.vercel.app/',
    tags: ['11 Parts', '54 Sections'],
    sections: ['prob_stats', 'calculus'],
    totalSections: 54,
    progressPrefix: 'shreve2:',
    leaderboardUrl: 'https://shreve2-deploy.vercel.app/#/leaderboard',
    shortName: 'Stochastic Calculus',
    progressGradient: 'linear-gradient(90deg, #8b5cf6, #a78bfa)',
  },
];
