...
export const COURSES = [
  ...
  },
  {
    ...
    icon: '🔐',
    url: 'https://frost-nine.vercel.app/',
    tags: ['10 Parts', '69 Sections'],
    sections: ['featured', 'number_theory'],
    totalSections: 69,
    progressPrefix: 'frost:',
    leaderboardUrl: 'https://frost-nine.vercel.app/#/leaderboard',
    shortName: 'FROST',
    progressGradient: 'linear-gradient(90deg, #6366f1, #818cf8)',
  },
  {
  ...
  },
  {
    ...
    icon: 'G',
    url: 'https://df-course-deploy.vercel.app/',
    tags: ['6 Parts', '95 Sections'],
    sections: ['algebra'],
    totalSections: 95,
    progressPrefix: 'df:',
    leaderboardUrl: 'https://df-course-deploy.vercel.app/#/leaderboard',
