...
// SCORING SYSTEM
// =============================================================================
// Calculates points for base conversion racing game answers.
...
import { getTierConfig, type BaseRacingTier } from './problemGenerator';
 ...
 */
export function scoreIncorrectAnswer(tier: BaseRacingTier): AnswerScore {
  const config = getTierConfig(tier);
  const basePoints = config.basePoints;
