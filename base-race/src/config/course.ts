 ...
 */
export const COURSE_ID: CourseId = 'base-race';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Base Conversion Racing';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'Race to convert numbers between binary, decimal, and hexadecimal!';
