...
for (const path of Object.keys(transcriptModules)) {
  // Extract transcript ID from filename (e.g., './pages/transcripts/BoltByBolt.tsx' -> 'bolt-by-bolt')
...
const transcriptIdMap: Record<string, string> = {
  'bolt-by-bolt': 'bolt-by-bolt',
  'bolt12-offers': 'bolt12-offers',
  'static-invoices': 'static-invoices',
  'lightning-overview': 'lightning-overview',
  'security-analysis': 'security-analysis',
  'multihop-routing': 'multihop-routing',
