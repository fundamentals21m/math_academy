        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-dark-400">
                  Podcast and conference discussions on Lightning Network protocol
                </p>
              </div>
            </div>

            <p className="text-dark-400 text-sm max-w-3xl">
              Curated summaries from btctranscripts.com featuring discussions with Lightning Network
              developers and researchers. These transcripts cover BOLT specifications, payment channels,
              HTLCs, onion routing, and protocol security.
            </p>
          </div>
          ...
          <div className="mb-6">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-11 rounded-xl bg-dark-800 border border-dark-700 text-dark-100 placeholder-dark-500 focus:border-amber-500 focus:ring-1 focus:ring-amber-500 outline-none transition-colors"
              />
              <svg
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {filteredTranscripts.map((transcript) => (
              <Link
                ...
                className="group p-6 rounded-2xl bg-dark-800/50 border border-dark-700/50 hover:border-amber-500/30 transition-all duration-300"
              >
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-amber-500/20 to-amber-600/10 flex items-center justify-center flex-shrink-0">
                    <span className="text-2xl">🎙️</span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="text-lg font-semibold text-dark-100 group-hover:text-amber-400 transition-colors mb-1">
                      {transcript.title}
                    </h3>
          ...
          <div className="mt-12 p-6 rounded-2xl bg-dark-800/30 border border-dark-700/30">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-dark-100 font-semibold mb-1">More Transcripts on btctranscripts.com</h3>
                <p className="text-dark-400 text-sm mb-3">
                  These are curated summaries. Find the full original transcripts and hundreds more
                  Bitcoin and Lightning technical discussions at btctranscripts.com.
                </p>
                <a
