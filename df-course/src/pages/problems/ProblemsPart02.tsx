      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering subgroups, centralizers, normalizers, stabilizers,
            cyclic groups and their properties, subgroup generation, and lattices of subgroups.
          </p>
        </motion.div>
