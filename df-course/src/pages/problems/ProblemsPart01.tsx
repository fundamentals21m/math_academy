      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Examples and exercises covering the definition of groups, dihedral groups,
            symmetric groups, matrix groups, the quaternion group, homomorphisms, and group actions.
          </p>
        </motion.div>
