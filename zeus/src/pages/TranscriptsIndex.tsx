        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-dark-400">
                  Podcast and interview discussions on Zeus, Lightning Network & self-custody
                </p>
              </div>
            </div>

            <p className="text-dark-400 text-sm max-w-3xl">
              Curated summaries from podcasts and interviews featuring Evan Kaloudis, the founder of Zeus.
              These transcripts cover building Zeus wallet, self-custody best practices, Lightning Network
              technology, Cashu eCash integration, and the fight for financial privacy.
            </p>
          </div>
          ...
          <div className="mt-12 p-6 rounded-2xl bg-dark-800/30 border border-dark-700/30">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-dark-100 font-semibold mb-1">More Zeus Content</h3>
                <p className="text-dark-400 text-sm mb-3">
                  These are curated summaries. Find more podcasts, interviews, and updates about
                  Zeus wallet at the official blog and community channels.
                </p>
                <a
