 ...
 */
export const COURSE_ID: CourseId = 'zeus';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Zeus Lightning Wallet';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'An interactive course for mastering the Zeus Bitcoin and Lightning Network wallet';
