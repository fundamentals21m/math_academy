 ...
 */
export const COURSE_NAME = 'Introduction to Graph Theory';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'An interactive course based on Douglas B. West\'s Introduction to Graph Theory';
