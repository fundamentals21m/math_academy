 ...
 */
export const COURSE_ID: CourseId = 'math_history';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Mathematics and Its History';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'A journey through the history of mathematics, from ancient Greece to modern times, based on John Stillwell\'s classic text';
