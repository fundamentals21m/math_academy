  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-emerald-500/[0.02] rounded-full blur-[150px] -translate-y-1/2 translate-x-1/2" />
      ...
      <div className="sticky top-16 z-30 h-1 bg-dark-900/80 backdrop-blur">
        <div
          className="h-full bg-gradient-to-r from-emerald-600 via-emerald-500 to-primary-400 transition-all duration-500 ease-out"
      ...
      <article className="relative max-w-4xl mx-auto px-6 py-12">
        ...
        <header className="mb-14">
          <div className="flex flex-wrap items-center gap-3 mb-6">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 text-sm font-semibold bg-gradient-to-r from-emerald-500/20 to-emerald-600/10 text-emerald-400 rounded-full border border-emerald-500/20">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="bg-gradient-to-r from-emerald-400 via-emerald-300 to-primary-400 bg-clip-text text-transparent">
              {transcript.title}
            </span>
          </h1>
            ...
            <div className="flex flex-wrap gap-3">
              {transcript.speakers.map((speaker, idx) => (
                <div key={idx} className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-500/30 to-primary-500/30 flex items-center justify-center">
        ...
        <div className="mt-12 p-6 rounded-2xl bg-gradient-to-br from-amber-500/10 to-amber-600/5 border border-amber-500/20">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-amber-400 font-semibold mb-1">Original Source</h3>
              <p className="text-dark-400 text-sm mb-3">
                This is an educational summary. Access the full original content at the source.
              </p>
              <a
      ...
      <nav className="relative max-w-4xl mx-auto px-6 py-12 border-t border-dark-800/50">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {prev ? (
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-dark-800/60 group-hover:bg-emerald-500/20 transition-all duration-300">
                <svg
                  className="w-5 h-5 text-dark-400 group-hover:text-emerald-400 group-hover:-translate-x-0.5 transition-all duration-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-dark-200 group-hover:text-emerald-400 transition-colors font-medium truncate">
                  {prev.title}
                </p>
              </div>
            </Link>
