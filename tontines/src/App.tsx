...
for (const path of Object.keys(transcriptModules)) {
  // Extract transcript ID from filename (e.g., './pages/transcripts/MilevskyHistory.tsx' -> 'milevsky-history')
...
const transcriptIdMap: Record<string, string> = {
  'milevsky-tontine-history': 'milevsky-tontine-history',
  'milevsky-annuity-man': 'milevsky-annuity-man',
  'mcclelland-tontine-trust': 'mcclelland-tontine-trust',
  'fullmer-tontine-design': 'fullmer-tontine-design',
  'brookings-gateway': 'brookings-gateway',
  'forman-tontine-pensions': 'forman-tontine-pensions',
  'donnelly-pooling': 'donnelly-pooling',
  'chen-optimal-tontine': 'chen-optimal-tontine',
};
