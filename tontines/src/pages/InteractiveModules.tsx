...
const modules: InteractiveModule[] = [
  {
    id: 'survival-curve',
    title: 'Survival Curve Explorer',
    description: 'Interactive visualization of survival probability S(t) using Gompertz-Makeham mortality. Compare male vs female curves, see life expectancy and median survival age.',
    sectionId: 4,
    sectionTitle: 'Survival Probability Basics',
    category: 'Mortality Math',
    icon: '📈',
  },
  {
    id: 'tontine-simulator',
    title: 'Tontine Simulator',
    description: 'Simulate a tontine pool year-by-year. Watch survivors decrease, pool value change, and payouts grow with mortality credits.',
    sectionId: 9,
    sectionTitle: 'Year-by-Year Calculation',
    category: 'Tontine Mechanics',
    icon: '🎲',
  },
  {
    id: 'pool-volatility',
    title: 'Pool Size Volatility',
    description: 'Monte Carlo simulation showing how pool size affects payment volatility. See why 500+ members are recommended for stability.',
    sectionId: 39,
    sectionTitle: 'Minimum Pool Size',
