            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-dark-400">
                  Talks, interviews, and presentations on tontines and longevity risk
                </p>
              </div>
            </div>

            <p className="text-dark-400 text-sm max-w-3xl">
              Curated summaries from leading experts in tontines, retirement finance, and actuarial science.
              These transcripts cover the history, mathematics, and future of longevity risk pooling.
            </p>
          </div>
          ...
          <div className="mb-6">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-11 rounded-xl bg-dark-800 border border-dark-700 text-dark-100 placeholder-dark-500 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-colors"
              />
              <svg
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {filteredTranscripts.map((transcript) => (
              <Link
                ...
                className="group p-6 rounded-2xl bg-dark-800/50 border border-dark-700/50 hover:border-emerald-500/30 transition-all duration-300"
              >
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 flex items-center justify-center flex-shrink-0">
                    <span className="text-2xl">🎙️</span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="text-lg font-semibold text-dark-100 group-hover:text-emerald-400 transition-colors mb-1">
                      {transcript.title}
                    </h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-dark-400 text-sm mb-3">
                  These transcripts feature leading voices in tontine research and retirement finance:
                </p>
                <div className="flex flex-wrap gap-2">
                  ...
                  <span className="text-xs px-3 py-1 rounded-full bg-dark-700 text-dark-300">
                    Richard Fullmer - Nuova Longevita
                  </span>
                  <span className="text-xs px-3 py-1 rounded-full bg-dark-700 text-dark-300">
                    Dean McClelland - Tontine Trust
                  </span>
                  <span className="text-xs px-3 py-1 rounded-full bg-dark-700 text-dark-300">
                    Jonathan Forman - U. Oklahoma
                  </span>
                </div>
              </div>
            </div>
