 ...
 */
export const COURSE_ID: CourseId = 'intro-discrete';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Intro to Discrete Math';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'Numbers, groups, and codes - combinatorics, group theory, and error-correcting codes';
