 ...
 */
export const COURSE_ID: CourseId = 'euler-intro';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Introduction to the Analysis of the Infinite';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = "Euler's 1748 masterpiece on the theory of curved lines, from conic sections to transcendental curves";
