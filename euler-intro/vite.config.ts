...
// =============================================================================
const COURSE_ID = 'euler-intro'  // Short ID: 'ba', 'aa', 'crypto', etc.

// Base path for standalone Vercel deployment
// This course is deployed to euler-intro.vercel.app (standalone)
const BASE_PATH = '/'
// =============================================================================
