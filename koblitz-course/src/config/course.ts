 ...
 */
export const COURSE_ID: CourseId = 'koblitz';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Number Theory and Cryptography';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'A graduate-level course in number theory and cryptography based on Koblitz';
