...
export const section11Quiz: QuizQuestion[] = [
  {
    ...
    options: ['All vectors with positive components', 'Vectors with integer components only', 'ℝⁿ', 'The empty set'],
    correctIndex: 2,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['At least two vectors', 'Only unit vectors', 'Exactly n vectors', 'The zero vector'],
    correctIndex: 3,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['A plane through the origin', 'A plane not through the origin', 'A line through the origin', 'The zero vector alone'],
    correctIndex: 1,
    difficulty: 'medium',
...
export const section12Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Infinitely many vectors', 'Only the zero vector', 'All of ℝⁿ', 'No vectors'],
    correctIndex: 1,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['Pivot columns', 'Rows of A', 'Non-pivot columns', 'Zero rows'],
    correctIndex: 2,
    difficulty: 'hard',
  ...
  },
  {
    ...
    options: ['Rank', 'Trace', 'Determinant', 'Nullity'],
    correctIndex: 3,
    difficulty: 'medium',
...
export const section13Quiz: QuizQuestion[] = [
  {
    ...
    options: ['x = xₚ + xₙ', 'xₚ only', 'xₙ only', 'x = xₚ × xₙ'],
    correctIndex: 0,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['A(xₙ) = b', 'xₚ = 0', 'A(xₙ) = 0', 'N(A) is empty'],
    correctIndex: 2,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['N(A)', 'Row space', 'N(Aᵀ)', 'C(A) (column space)'],
    correctIndex: 3,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['Is consistent (has at least one solution)', 'Has no solution', 'Has a unique solution', 'Has exactly rank solutions'],
    correctIndex: 0,
    difficulty: 'hard',
...
export const section14Quiz: QuizQuestion[] = [
  {
    ...
    options: ['They span ℝⁿ', 'c₁v₁ + ... + cₖvₖ = 0 has only the trivial solution', 'They are orthogonal', 'k = n'],
    correctIndex: 1,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['The number of vectors in any spanning set', 'The number of equations', 'n', 'The number of vectors in a basis'],
    correctIndex: 3,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['Dependent', 'Independent', 'Orthogonal', 'A basis'],
    correctIndex: 0,
    difficulty: 'medium',
...
export const section15Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Number of rows', 'Number of columns', 'Number of entries', 'Number of pivots'],
    correctIndex: 3,
    difficulty: 'easy',
...
export const chapter03Quiz: QuizQuestion[] = [
  {
    ...
    options: ['Contains only positive vectors', 'Contains exactly n vectors', 'Contains the vector (1,1,...,1)', 'Closed under addition and scalar multiplication'],
    correctIndex: 3,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Always a subspace', 'Never a subspace', 'A subspace only if they\'re equal', 'Empty'],
    correctIndex: 0,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['Not in the column space of A', 'In the null space of A', 'In the column space of A', 'Zero'],
    correctIndex: 0,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['rank = 0', 'rank = max(m,n)', 'rank = m + n', 'rank = min(m,n)'],
    correctIndex: 3,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Orthogonal complements in ℝᵐ', 'Equal', 'The same dimension', 'Both subspaces of ℝⁿ'],
    correctIndex: 0,
    difficulty: 'hard',
