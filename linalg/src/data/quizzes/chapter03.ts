...
export const section11Quiz: QuizQuestion[] = [
  {
    ...
    options: [
      'All vectors with positive components',
      'Vectors with integer components only',
      'The empty set',
      'ℝⁿ',
    ],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: [
      ...
      'A plane not through the origin',
...
export const section14Quiz: QuizQuestion[] = [
  {
    ...
    options: [
      'They span ℝⁿ',
      'c₁v₁ + ... + cₖvₖ = 0 has only the trivial solution',
      'They are orthogonal',
      'k = n',
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: [
      'Spans V only',
      'Is independent only',
      'Contains all vectors of V',
      'Spans V and is independent',
    ],
    correctIndex: 3,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: [
      'The number of vectors in any spanning set',
...
export const chapter03Quiz: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      'Contains only positive vectors',
  ...
  },
  {
    ...
    options: [
      'Never a subspace',
      'Always a subspace',
      'A subspace only if they\\\'re equal',
      'Empty',
    ],
    correctIndex: 1,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: [
      'Equal',
      'Orthogonal complements in ℝᵐ',
      'The same dimension',
      'Both subspaces of ℝⁿ',
    ],
    correctIndex: 1,
    difficulty: 'hard',
