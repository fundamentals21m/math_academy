...
export const section28Quiz: QuizQuestion[] = [
  {
    ...
    options: ['A = UΣVᵀ', 'A = LU', 'A = QR', 'A = SDS⁻¹'],
    correctIndex: 0,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Eigenvectors of A', 'Left singular vectors', 'Random orthonormal vectors', 'Eigenvectors of AᵀA'],
    correctIndex: 3,
    difficulty: 'hard',
...
export const section29Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Complex', 'Non-negative real', 'Negative', 'Zero'],
    correctIndex: 1,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Square n×n', 'n×m', 'Always square', 'm×n with zeros below'],
    correctIndex: 3,
    difficulty: 'hard',
...
export const section30Quiz: QuizQuestion[] = [
  {
    ...
    options: ['Maximize variance', 'Minimize variance', 'Keep all data', 'Are random'],
    correctIndex: 0,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Full SVD', 'Eigendecomposition', 'Low-rank approximation', 'QR factorization'],
    correctIndex: 2,
    difficulty: 'medium',
...
export const section31Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['A = QR', 'A = LU', 'A = UΣ', 'A = QS where Q orthogonal, S symmetric positive semidefinite'],
    correctIndex: 3,
    difficulty: 'hard',
...
export const chapter07Quiz: QuizQuestion[] = [
  {
    ...
    options: ['Orthogonal', 'Lower triangular', 'Upper triangular', 'Diagonal'],
    correctIndex: 0,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Only U', 'Only V', 'Σ entries', 'U and V columns'],
    correctIndex: 3,
    difficulty: 'hard',
  ...
  },
  {
    ...
    options: ['Low-rank approximation is optimal', 'It\'s fast', 'It works only on images', 'It increases data size'],
    correctIndex: 0,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['σ₁', 'Product of singular values', 'Largest eigenvalue', 'Sum of all singular values'],
    correctIndex: 3,
    difficulty: 'hard',
  ...
  },
  {
    ...
    options: ['Uₖ, Σₖ, Vₖ', 'The full matrix A', 'Only Σ', 'Only U'],
    correctIndex: 0,
    difficulty: 'medium',
