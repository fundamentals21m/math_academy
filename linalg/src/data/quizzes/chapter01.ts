...
export const section01Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['A line through the origin', 'A single point', 'A circle', 'The entire plane ℝ²'],
    correctIndex: 3,
    difficulty: 'medium',
...
export const section02Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['1', '-1', 'Their product of lengths', '0'],
    correctIndex: 3,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['(3/5, 4/5)', '(1, 1)', '(2, 0)', '(0.5, 0.5)'],
    correctIndex: 0,
    difficulty: 'medium',
...
export const section03Quiz: QuizQuestion[] = [
  {
    ...
    options: ['2×3 matrix', '6×1 matrix', '3×2 matrix', 'Square matrix'],
    correctIndex: 2,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['A vector', 'A scalar', 'The solution', 'A coefficient matrix'],
    correctIndex: 3,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Infinitely many', 'Zero', 'Exactly one', 'Cannot be determined'],
    correctIndex: 0,
    difficulty: 'medium',
...
export const chapter01Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['The entire plane', 'A point', 'A line through the origin', 'A circle'],
    correctIndex: 2,
    difficulty: 'hard',
  ...
  },
  {
    ...
    options: ['Columns of A', 'Rows of A', 'Rows of b', 'The vector x'],
    correctIndex: 0,
    difficulty: 'hard',
