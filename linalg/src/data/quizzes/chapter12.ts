...
export const section48Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'The maximum',
      'The minimum',
      'The spread (average squared deviation)',
    ],
    correctIndex: 3,
    difficulty: 'easy',
...
export const section50Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      'PCA or SVD for dimensionality reduction',
      'Only raw features',
      'Random projection',
      'No preprocessing',
    ],
...
export const chapter12Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Sum of top k eigenvalues / sum of all eigenvalues',
      'k/n',
    ],
    correctIndex: 2,
    difficulty: 'hard',
