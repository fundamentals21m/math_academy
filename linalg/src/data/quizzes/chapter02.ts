...
export const section04Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['A row of A', 'The determinant', 'A linear combination of columns of A', 'A pivot'],
    correctIndex: 2,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Intersecting lines', 'Identical lines', 'Perpendicular lines', 'Parallel lines'],
    correctIndex: 3,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['The system has at least one solution', 'The system has no solution', 'A is invertible', 'b = 0'],
    correctIndex: 0,
    difficulty: 'medium',
...
export const section05Quiz: QuizQuestion[] = [
  {
    ...
    options: ['Diagonal', 'Lower triangular', 'Upper triangular', 'Identity'],
    correctIndex: 2,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Any nonzero entry', 'The largest entry', 'The entry a₁ₙ', 'The entry a₁₁'],
    correctIndex: 3,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['When the pivot is 0', 'When the pivot is 1', 'When the pivot is negative', 'Never'],
    correctIndex: 0,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['aⱼⱼ/aᵢⱼ', 'aᵢⱼ/aⱼⱼ', 'aᵢⱼ × aⱼⱼ', 'aᵢⱼ - aⱼⱼ'],
    correctIndex: 1,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['Consistent', 'Has infinitely many solutions', 'Inconsistent', 'Homogeneous'],
    correctIndex: 2,
    difficulty: 'hard',
...
export const section06Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['E₂₁ (row 2)', 'E₃₁ (row 3)', 'Both simultaneously', 'Neither'],
    correctIndex: 0,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['The first equation', 'Any equation', 'The last equation', 'The middle equation'],
    correctIndex: 2,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['U', 'A', 'I', 'L (lower triangular)'],
    correctIndex: 3,
    difficulty: 'hard',
...
export const section07Quiz: QuizQuestion[] = [
  {
    ...
    options: ['When they have the same dimensions', 'Always', 'When A is square', 'When B is square'],
    correctIndex: 0,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['The number of columns of B', 'The number of rows of B', 'The number of rows of A', '1'],
    correctIndex: 1,
    difficulty: 'easy',
...
export const section08Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Singular', 'Orthogonal', 'Invertible (nonsingular)', 'Symmetric'],
    correctIndex: 2,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['All pivots are nonzero', 'A is square', 'A = Aᵀ', 'det(A) = 0'],
    correctIndex: 3,
    difficulty: 'medium',
...
export const section09Quiz: QuizQuestion[] = [
  {
    ...
    options: ['Upper triangular', 'Diagonal', 'Lower triangular', 'Orthogonal'],
    correctIndex: 2,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['The pivots', 'Always 1', 'Always 0', 'The multipliers from elimination'],
    correctIndex: 3,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['Solving Ax = b for multiple b vectors efficiently', 'It never fails', 'It works for any matrix', 'It is faster than elimination'],
    correctIndex: 0,
    difficulty: 'medium',
...
export const section10Quiz: QuizQuestion[] = [
  {
    ...
    options: ['Diagonal entries', 'First and last rows', 'Positive and negative entries', 'Rows and columns'],
    correctIndex: 3,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Impossible', 'A = PLU', 'A = UP', 'PA = LU'],
    correctIndex: 3,
    difficulty: 'hard',
...
export const chapter02Quiz: QuizQuestion[] = [
  {
    ...
    options: ['U (upper triangular)', 'L (lower triangular)', 'D (diagonal)', 'I (identity)'],
    correctIndex: 0,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['The system has a unique solution', 'The matrix is singular', 'The system is inconsistent', 'We multiply by -1'],
    correctIndex: 1,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['Always singular', 'Invertible only if A = B', 'Sometimes invertible', 'Always invertible'],
    correctIndex: 3,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['Three lines', 'A single plane', 'Three planes', 'A line'],
    correctIndex: 2,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['A is invertible', 'All entries are positive', 'A² = I', 'aᵢⱼ = aⱼᵢ for all i, j'],
    correctIndex: 3,
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['Involutory', 'Symmetric', 'Orthogonal', 'Nilpotent'],
    correctIndex: 0,
    difficulty: 'hard',
