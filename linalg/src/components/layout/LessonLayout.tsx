...
export function LessonLayout({ sectionId, children }: LessonLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-dark-950">
      ...
      {/* Progress bar */}
      <div className={`fixed top-16 left-0 right-0 z-30 h-1 bg-dark-800 transition-all duration-300 ${sidebarOpen ? 'lg:left-72' : ''}`}>
        <motion.div
      ...
      {/* Main content */}
      <main className={`pt-20 pb-24 px-4 lg:pr-8 transition-all duration-300 ${sidebarOpen ? 'lg:pl-80' : 'lg:pl-8'}`}>
