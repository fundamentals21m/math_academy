 ...
 */
export const COURSE_ID: CourseId = 'rothbard_controversies';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Economic Controversies (Rothbard)';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'An interactive course on Economic Controversies by Murray Rothbard';
