            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-dark-400">
                  Podcast and conference discussions on libsecp256k1 cryptography
                </p>
              </div>
            </div>

            <p className="text-dark-400 text-sm max-w-3xl">
              Curated summaries from btctranscripts.com featuring discussions with the cryptographers
              behind Bitcoin's elliptic curve implementations. These transcripts cover libsecp256k1,
          ...
          <div className="mb-6">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pl-11 rounded-xl bg-dark-800 border border-dark-700 text-dark-100 placeholder-dark-500 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 outline-none transition-colors"
              />
              <svg
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {filteredTranscripts.map((transcript) => (
              <Link
                ...
                className="group p-6 rounded-2xl bg-dark-800/50 border border-dark-700/50 hover:border-cyan-500/30 transition-all duration-300"
              >
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500/20 to-cyan-600/10 flex items-center justify-center flex-shrink-0">
                    <span className="text-2xl">🎙️</span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="text-lg font-semibold text-dark-100 group-hover:text-cyan-400 transition-colors mb-1">
                      {transcript.title}
                    </h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-dark-400 text-sm mb-3">
                  ...
                  Bitcoin technical discussions at btctranscripts.com.
                </p>
                <a
