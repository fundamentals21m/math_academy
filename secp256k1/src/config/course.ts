 ...
 */
export const COURSE_ID: CourseId = 'secp256k1';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'secp256k1: The Curve That Powers Bitcoin';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'From geometry to cryptography—the mathematics that makes Bitcoin possible';
