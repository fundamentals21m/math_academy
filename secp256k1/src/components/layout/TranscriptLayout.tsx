  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-cyan-500/[0.02] rounded-full blur-[150px] -translate-y-1/2 translate-x-1/2" />
      ...
      <div className="sticky top-16 z-30 h-1 bg-dark-900/80 backdrop-blur">
        <div
          className="h-full bg-gradient-to-r from-cyan-600 via-cyan-500 to-primary-400 transition-all duration-500 ease-out"
      ...
      <article className="relative max-w-4xl mx-auto px-6 py-12">
        ...
        <header className="mb-14">
          <div className="flex flex-wrap items-center gap-3 mb-6">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 text-sm font-semibold bg-gradient-to-r from-cyan-500/20 to-cyan-600/10 text-cyan-400 rounded-full border border-cyan-500/20">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="bg-gradient-to-r from-cyan-400 via-cyan-300 to-primary-400 bg-clip-text text-transparent">
              {transcript.title}
            </span>
          </h1>
            ...
            <div className="flex flex-wrap gap-3">
              {transcript.speakers.map((speaker, idx) => (
                <div key={idx} className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-cyan-500/30 to-primary-500/30 flex items-center justify-center">
          ...
          <div className="mt-10 flex items-center gap-4">
            ...
            <div className="flex gap-1">
              ...
              <span className="w-1.5 h-1.5 rounded-full bg-cyan-500/10" />
            </div>
            <div className="h-px flex-1 bg-gradient-to-r from-transparent via-dark-700 to-transparent" />
          </div>
        </header>
      ...
      <nav className="relative max-w-4xl mx-auto px-6 py-12 border-t border-dark-800/50">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {prev ? (
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-dark-800/60 group-hover:bg-cyan-500/20 transition-all duration-300">
                <svg
                  className="w-5 h-5 text-dark-400 group-hover:text-cyan-400 group-hover:-translate-x-0.5 transition-all duration-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-dark-200 group-hover:text-cyan-400 transition-colors font-medium truncate">
                  {prev.title}
                </p>
              </div>
            </Link>
          ...
          {next ? (
            ...
            <Link
              to="/transcripts"
              className="group flex items-center justify-center gap-3 p-5 rounded-2xl bg-gradient-to-r from-cyan-600 to-cyan-500 text-white font-semibold shadow-lg shadow-cyan-500/20 hover:shadow-xl hover:shadow-cyan-500/30 hover:scale-[1.02] transition-all duration-300"
            >
