 ...
 */
export const COURSE_ID: CourseId = 'only-the-strong-survive';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Only The Strong Survive';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'A Philosophical, Technical, and Economic Critique of Prospects in "Crypto" Beyond Bitcoin';
