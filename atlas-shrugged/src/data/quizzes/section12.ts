...
export const section12Questions: QuizQuestion[] = [
  ...
  },
  {
    id: 5,
    type: 'multiple-choice',
    question: 'What is the defense against white blackmail, according to Rand?',
    options: [
    ...
    correctIndex: 0,
    difficulty: 'hard',
    explanation: 'The defense is to refuse unearned guilt - to recognize that being productive and successful is not a sin requiring atonement.',
  },
  {
    id: 6,
    type: 'multiple-choice',
    question: 'How does white blackmail connect to the novel\'s broader theme of exploitation?',
    options: [
      'It shows exploitation only happens through force',
      'It reveals how moral codes become tools of exploitation',
      'It proves exploitation is impossible',
      'It demonstrates government is the only exploiter'
    ],
    correctIndex: 1,
    difficulty: 'hard',
    explanation: 'White blackmail demonstrates that the altruist moral code itself is a tool of exploitation, extracting value through guilt rather than guns.',
  },
];
