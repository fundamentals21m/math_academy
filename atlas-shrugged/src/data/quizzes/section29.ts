...
export const section29Questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctIndex: 1,
    difficulty: 'hard',
    explanation: 'The strikers must wait for the looters\' system to completely fail. They cannot rebuild while force and looter morality still reign. The collapse must be total.',
  },
  {
    id: 6,
    type: 'multiple-choice',
