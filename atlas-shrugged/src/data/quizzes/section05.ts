...
export const section05Questions: QuizQuestion[] = [
  ...
  },
  {
    id: 4,
    type: 'multiple-choice',
    question: 'How do the "non-commercial" characters view artistic or intellectual work compared to business?',
    options: [
      'As equally valuable',
  ...
  },
  {
    id: 5,
    type: 'multiple-choice',
    question: 'What does Rand suggest about the relationship between commerce and civilization?',
    options: [
      'Commerce corrupts civilization',
      'Commerce is irrelevant to civilization',
      'Commerce is the foundation of civilized life',
      'Commerce should be eliminated for true progress'
    ],
    correctIndex: 2,
    difficulty: 'hard',
    explanation: 'Rand argues that voluntary commercial exchange is foundational to civilization, enabling peaceful cooperation and material progress.',
  },
  {
    id: 6,
    type: 'multiple-choice',
    question: 'What moral inversion does the chapter identify in society\'s view of commerce?',
    options: [
    ...
    correctIndex: 3,
    difficulty: 'hard',
    explanation: 'The chapter shows how society inverts morality by treating wealth creators as exploiters while celebrating those who produce nothing but claim moral virtue.',
  },
];
