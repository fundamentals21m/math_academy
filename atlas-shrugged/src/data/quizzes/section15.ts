...
export const section15Questions: QuizQuestion[] = [
  ...
  },
  {
    id: 5,
    type: 'multiple-choice',
    question: 'What does the term "Miracle Metal" refer to in the context of the chapter?',
    options: [
    ...
    correctIndex: 2,
    difficulty: 'hard',
    explanation: '"Miracle Metal" refers to the revolutionary quality of Rearden Metal, which is stronger, lighter, and more durable than any metal ever produced. It truly is a miracle of human ingenuity.',
  },
  {
    id: 6,
    type: 'multiple-choice',
    question: 'What philosophical theme does the persecution of Rearden Metal illustrate?',
    options: [
