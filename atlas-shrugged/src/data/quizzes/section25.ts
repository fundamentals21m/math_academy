...
export const section25Questions: QuizQuestion[] = [
  ...
  },
  {
    id: 2,
    type: 'multiple-choice',
    question: 'What does Halley\'s music represent in the novel?',
    options: [
  ...
  },
  {
    id: 3,
    type: 'multiple-choice',
    question: 'Why did Richard Halley originally leave the outside world?',
    options: [
    ...
    correctIndex: 2,
    difficulty: 'medium',
    explanation: 'Halley left because after years of being unjustly attacked, he was suddenly praised—but by people who hadn\'t changed. Their acceptance meant nothing because they still didn\'t truly value his work.',
  },
  {
    id: 4,
    type: 'multiple-choice',
  ...
  },
  {
    id: 5,
    type: 'multiple-choice',
    question: 'What is the relationship between art and philosophy in Rand\'s view as shown through Halley?',
    options: [
  ...
  },
  {
    id: 6,
    type: 'multiple-choice',
    question: 'Why can Halley only compose "The Concerto of Deliverance" in the valley?',
    options: [
    ...
    correctIndex: 3,
    difficulty: 'hard',
    explanation: 'The concerto could only be created in the valley because only there, among people who truly understand and share his values, can Halley experience the joy that the music expresses.',
  },
];
