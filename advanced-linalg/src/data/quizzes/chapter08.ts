...
// Section 47: Linear Functionals and Adjoints (Used as Section 11: Diagonalization in curriculum)
export const section47Quiz: DifficultyQuizData = {
  easy: [
    {
      id: 's47-e01',
      question: 'A matrix is diagonalizable if it can be written as:',
      options: ['A = P + D', 'A = PDP⁻¹ where D is diagonal', 'A = D²', 'A = I'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['All zero', 'The off-diagonal entries', 'The diagonal entries', 'Undefined'],
      correctIndex: 2,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['2λ₁,...,2λₙ', 'λ₁²,...,λₙ²', 'λ₁+1,...,λₙ+1', '√λ₁,...,√λₙ'],
      correctIndex: 1,
      difficulty: 'medium',
...
// Section 48: Unitary Operators (Used as Section 12: Jordan Canonical Form in curriculum)
export const section48Quiz: DifficultyQuizData = {
  easy: [
    {
      id: 's48-e01',
...
export const chapter08Quiz: DifficultyQuizData = {
  easy: [],
  medium: [],
  hard: [
    {
