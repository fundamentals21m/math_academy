...
export const section01Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: [
      'It lacks a multiplicative identity',
      'It lacks an additive identity',
      'It is not closed under addition',
      'It lacks multiplicative inverses',
    ],
      correctIndex: 0,
      difficulty: 'easy',
  ...
  medium: [
    {
      ...
      'They have the same number of unknowns',
      'Each equation in one is a linear combination of equations in the other',
    ],
      correctIndex: 3,
      difficulty: 'medium',
...
export const section03Quiz: DifficultyQuizData = {
  easy: [
    {
      ...
      options: [
      'Add two rows and store in a third row',
    ...
    },
    {
      ...
      'Changes its rank',
      'Changes its solution set for Ax = 0',
      'Cannot be undone',
    ],
      correctIndex: 0,
      difficulty: 'easy',
    ...
    },
    {
      ...
      'Allowed only for zero rows',
      'The same as deleting a row',
    ],
      correctIndex: 0,
      difficulty: 'easy',
    ...
    },
    {
      ...
      'One can be obtained from the other by elementary row operations',
  ...
  medium: [
    ...
    },
    {
      ...
      options: [
      'Reversible by an operation of the same type',
      'Irreversible',
      'Only applicable to square matrices',
      'Commutative with other operations',
    ],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      'No common solutions',
      'At least one common solution',
      'Solutions differing by a constant',
      'Exactly the same solutions',
    ],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      ...
      'Add -c times row i to another row',
      'Interchange row i with another',
    ],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      'The solution set of AX = b for all b',
      'The column space',
    ],
      correctIndex: 0,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      'The first non-zero entry in each row is 1, and that column has all other entries 0',
    ...
    },
    {
      ...
      options: [
      'Any 2×2 matrix',
      'The result of performing one elementary row operation on I',
      'Always diagonal',
      'Never invertible',
    ],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [
      'Performs the corresponding row operation on A',
      'Performs a column operation on A',
      'Has no effect',
      'Makes A invertible',
    ],
      correctIndex: 0,
...
export const section04Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: [
      'Any entry equal to 1',
      'The diagonal entries',
      'The largest entry in each row',
      'The location of a leading 1 in RREF',
    ],
      correctIndex: 3,
      difficulty: 'easy',
  ...
  medium: [
    {
      ...
      options: [
      'Be on the diagonal',
      'Move strictly to the right as rows increase',
      'All be in the same column',
    ...
    },
    {
      ...
      options: [
      'A unique row-reduced echelon matrix',
      'The identity matrix',
      'Multiple row-reduced echelon matrices',
      'No row-reduced matrix',
    ],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: [
      'All entries equal to 0 or 1',
      'At least one leading 1',
      'The same entries as the original',
      'No zero rows',
    ],
      correctIndex: 1,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      'The same dimension only if square',
      'No relationship',
      'The same dimension',
    ],
      correctIndex: 3,
...
export const section05Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: [
      'The number zero',
      'The zero matrix of appropriate size',
      'Undefined',
      'Equal to A',
    ],
      correctIndex: 1,
  ...
  hard: [
    {
      ...
      options: [
      'AB = BA always',
      'AB and BA have the same size',
      'AB and BA may have different sizes',
      'AB and BA have the same rank',
    ],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      question: 'rank(AB) is:',
      options: [
      'Always equal to rank(A)',
      'Always equal to rank(B)',
      'Always equal to rank(A) · rank(B)',
      'At most min(rank(A), rank(B))',
    ],
      correctIndex: 3,
      difficulty: 'hard',
...
export const section06Quiz: DifficultyQuizData = {
  ...
  medium: [
    ...
    },
    {
      ...
      'Always invertible',
      'Never invertible',
      'Invertible only if square',
      'Invertible only if symmetric',
    ],
      correctIndex: 0,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: [
      'A is invertible but B might not be',
      'B is invertible but A might not be',
      'Neither A nor B need be invertible',
...
export const chapter01Quiz: DifficultyQuizData = {
  ...
  hard: [
    ...
    },
    {
      ...
      'Never invertible',
      'Always invertible',
      'Invertible only if they commute',
      'Sometimes invertible',
    ],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      'A and B are unique',
      'A = B',
      'B is the unique inverse of A',
      'A and B are both symmetric',
    ],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: [
      'Changing the unknowns',
      'Adding a new equation',
      'Forming a linear combination of equations',
    ...
    },
    {
      ...
      options: [
      'A field',
      'Closed under multiplication but not a field',
      'Not closed under multiplication',
      'Equal to ℝ⁴ as a field',
    ],
      correctIndex: 1,
      difficulty: 'hard',
