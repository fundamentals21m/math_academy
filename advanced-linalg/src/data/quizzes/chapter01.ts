...
export const section01Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['0', '1', '2', 'It depends on the field'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['An additive inverse only', 'A multiplicative inverse only', 'Both additive and multiplicative inverses', 'No inverses'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Only addition', 'Only multiplication', 'Both addition and multiplication', 'Neither'],
      correctIndex: 2,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['a(b + c) = ab + ac', 'a + (bc) = (a + b)(a + c)', '(ab)c = a(bc)', 'a + b = b + a'],
      correctIndex: 0,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['Any positive integer', 'A prime number', 'A prime power', 'An even number'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['ℝ itself', 'ℚ', 'ℂ', 'Does not exist'],
      correctIndex: 2,
      difficulty: 'hard',
...
export const section02Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['x = (1, 1, ..., 1)', 'x = (0, 0, ..., 0)', 'x does not exist', 'x = (1, 0, ..., 0)'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['ax² + by² + cz² = d', 'ax + by + cz = d', 'xyz = d', '1/x + 1/y + 1/z = d'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['The row space of A', 'The column space of A', 'The null space of A', 'The range of A'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['A is invertible', 'b is in the column space of A', 'b = 0', 'A is square'],
      correctIndex: 1,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['The null space of A', 'A particular solution plus the null space', 'The column space of A', 'The row space of A'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['No solutions', 'At most one solution', 'Infinitely many solutions', 'Exactly n solutions'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['A has rank n', 'A has rank less than n', 'A is symmetric', 'A is upper triangular'],
      correctIndex: 0,
      difficulty: 'hard',
...
export const section03Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['Changes its rank', 'Changes its solution set for Ax = 0', 'Is an elementary row operation', 'Cannot be undone'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['An elementary row operation', 'Not an elementary row operation', 'Allowed only for zero rows', 'The same as deleting a row'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['They have the same size', 'They have the same rank', 'One can be obtained from the other by elementary row operations', 'They are equal'],
      correctIndex: 2,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['Add c times row j to row i', 'Add -c times row i to row j', 'Multiply row j by -c', 'Interchange rows i and j'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['The entries of the matrix', 'The solution set of AX = b for all b', 'The row space', 'The column space'],
      correctIndex: 2,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['Any 2×2 matrix', 'The result of performing one elementary row operation on I', 'Always diagonal', 'Never invertible'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Performs a column operation on A', 'Performs the corresponding row operation on A', 'Has no effect', 'Makes A invertible'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Diagonal matrices', 'Elementary matrices', 'Symmetric matrices', 'Upper triangular matrices'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['The number of rows', 'The number of columns', 'The number of pivot positions in its RREF', 'The number of zero rows'],
      correctIndex: 2,
      difficulty: 'hard',
...
export const section04Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['0', '1', 'Any non-zero number', 'The row number'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Row echelon form only', 'Reduced row echelon form', 'Neither echelon form', 'Cannot be determined'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Free column', 'Pivot column', 'Basic column', 'Zero column'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Basic variables', 'Free variables', 'Dependent variables', 'Leading variables'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['All entries equal to 1', 'All other entries equal to 0', 'Entries summing to 1', 'At most one non-zero entry'],
      correctIndex: 1,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['The system has infinitely many solutions', 'The system has a unique solution', 'The system is inconsistent', 'The system is homogeneous'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['m non-zero rows', 'n non-zero rows', 'r non-zero rows', 'm - r non-zero rows'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['The same dimension', 'Different dimensions', 'The same dimension only if square', 'No relationship'],
      correctIndex: 0,
      difficulty: 'hard',
...
export const section05Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['A and B to be square', 'A and B to have the same size', 'Columns of A = rows of B', 'Rows of A = columns of B'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['The number zero', 'The zero matrix of appropriate size', 'Undefined', 'Equal to A'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Never', 'Only for square matrices', 'Always (when defined)', 'Only for diagonal matrices'],
      correctIndex: 2,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['Always', 'Never', 'Sometimes', 'Only if A = B'],
      correctIndex: 2,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['A = 0', 'B = 0', 'A = 0 or B = 0', 'None of the above (A and B can both be non-zero)'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      id: 's05-h04',
      question: 'rank(AB) is:',
      options: ['Always equal to rank(A)', 'Always equal to rank(B)', 'At most min(rank(A), rank(B))', 'Always equal to rank(A) · rank(B)'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Involutory', 'Idempotent', 'Nilpotent', 'Unitary'],
      correctIndex: 0,
      difficulty: 'hard',
...
export const section06Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['Not invertible', 'Its own inverse', 'Never used in practice', 'Only defined for 2×2'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['All zero', 'Linearly independent', 'All equal', 'Orthogonal to each other'],
      correctIndex: 1,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['All of Fⁿ', 'A line through the origin', '{0}', 'The same as the column space'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      id: 's06-h03',
      question: 'Every invertible matrix is a product of:',
      options: ['At most 2 matrices', 'Elementary matrices', 'Diagonal matrices', 'Symmetric matrices'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['A is invertible but B might not be', 'B is invertible but A might not be', 'Both A and B are invertible', 'Neither A nor B need be invertible'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['The zero matrix', 'The identity matrix', 'Any idempotent matrix', '-I'],
      correctIndex: 1,
      difficulty: 'hard',
