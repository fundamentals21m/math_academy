...
export const section20Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['Only a vector space', 'An algebra with matrix multiplication', 'A field', 'A group'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Non-commutative', 'Commutative', 'Finite-dimensional', 'A field'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['No identity', 'A multiplicative identity element', 'Exactly one element', 'Infinite dimension'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Non-commutative', 'Commutative', 'Not closed under multiplication', 'Trivial'],
      correctIndex: 1,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['Only ℝ', 'ℝ and ℂ', 'ℝ, ℂ, and ℍ (quaternions)', 'Infinitely many'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['I = 0', 'Every element of I is nilpotent', 'I² = I', 'I is maximal'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Always zero', 'The intersection of all maximal left ideals', 'The center', 'The whole algebra'],
      correctIndex: 1,
      difficulty: 'hard',
...
export const section21Quiz: DifficultyQuizData = {
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['n² roots', 'n roots', '2n roots', 'Infinitely many roots'],
      correctIndex: 1,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['nxⁿ⁻¹ always', '0 if p | n', 'Undefined', 'xⁿ'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['With no roots', 'With no repeated roots in any extension', 'Of degree 1', 'With real coefficients'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Linear', 'Separable', 'Monic', 'Of even degree'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Its degree', 'The gcd of its coefficients', 'Its leading coefficient', 'Its constant term'],
      correctIndex: 1,
      difficulty: 'hard',
...
export const section22Quiz: DifficultyQuizData = {
  easy: [
    {
      ...
      options: ['No points', 'Given data points', 'Only one point', 'Infinitely many points'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Different', 'Equal', 'Orthogonal', 'Independent'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Only ℝ', 'Only ℂ', 'Any field', 'Only finite fields'],
      correctIndex: 2,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['All values are 0', 'The interpolation points are distinct', 'n = 1', 'The matrix is square'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['A different polynomial than Lagrange', 'The same polynomial in a different form', 'An approximation', 'Only linear interpolation'],
      correctIndex: 1,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['The degree', 'The maximum interpolation error (Runge phenomenon)', 'Computation time', 'The number of points'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Fast convergence', 'Oscillation at endpoints with equally spaced nodes', 'Numerical instability', 'Perfect interpolation'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Only function values', 'Derivatives at interpolation points', 'Integrals', 'Fourier coefficients'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['A unique polynomial of any degree', 'No polynomial', 'A polynomial of degree < |F|', 'The zero polynomial'],
      correctIndex: 2,
      difficulty: 'hard',
...
export const section23Quiz: DifficultyQuizData = {
  easy: [
    {
      ...
      options: ['Only addition', 'Addition and multiplication by any polynomial', 'Only multiplication', 'Nothing'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['No elements', 'One element', 'Two elements', 'Infinitely many elements'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['All polynomials', 'Only 0', 'All constants', 'Only monic polynomials'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['f and g share a root', 'gcd(f, g) = 1', 'f = g', 'f and g are irreducible'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['(f + g)', '(fg)', '(lcm(f, g))', '(gcd(f, g))'],
      correctIndex: 3,
      difficulty: 'hard',
...
export const section24Quiz: DifficultyQuizData = {
  easy: [
    {
      ...
      options: ['Any factors', 'Lower-degree polynomial factors over the field', 'Real factors', 'Integer factors'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Reducible', 'Irreducible', 'Zero', 'Units'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Irreducible', '(x-1)(x+1)', '(x-i)(x+i)', 'x·x - 1'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['The degree', 'The total degree or length', 'The content', 'The norm'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['Only ℝ', 'ℚ, ℝ, and ℂ', 'ℚ and ℝ but not ℂ', 'No field'],
      correctIndex: 2,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['Always reducible', 'The minimal polynomial of primitive n-th roots of unity over ℚ', 'xⁿ - 1', 'Of degree n'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Only degree 1', 'Only prime degrees', 'Every positive degree', 'No degrees'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['1', 'deg(f)', '2·deg(f)', 'Infinite'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Only the polynomial itself', 'The base field', 'Only the degree', 'Only the leading coefficient'],
      correctIndex: 1,
      difficulty: 'hard',
