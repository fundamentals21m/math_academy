...
export const section56Quiz: DifficultyQuizData = {
  easy: [
    {
      ...
      options: ['Linear in one variable', 'Quadratic', 'Linear in both variables', 'Constant'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['f(vᵢ) + f(vⱼ)', '⟨vᵢ,vⱼ⟩', 'δᵢⱼ', 'f(vᵢ,vⱼ)'],
      correctIndex: 3,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['f(u,v) = f(v,u)', 'f(u,u) = 1', 'f(u,v) = -f(v,u)', 'f is symmetric'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['f(u,v)', 'Always zero', '||f||', 'Q(v) = f(v,v)'],
      correctIndex: 3,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['Always n', 'Always 0', 'The rank of its matrix', 'Undefined'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['B = B\'', 'They have the same rank', 'They are both symmetric', 'B\' = PᵀBP for some invertible P'],
      correctIndex: 3,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['ker(f)', 'V', '{v : f(v,w) = 0 for all w}', '{0}'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['V', 'One-dimensional', 'Undefined', '{0}'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['They have the same rank', 'They have the same signature', 'They are equal', 'They have the same determinant'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Empty', 'All invertible matrices', '{A : f(Av, Aw) = f(v,w) for all v,w}', 'Only the identity'],
      correctIndex: 2,
      difficulty: 'hard',
...
export const section57Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['Its determinant', 'Always (n, 0)', 'Undefined', '(# positive, # negative diagonal entries in diagonalized form)'],
      correctIndex: 3,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['(n, 0)', '(0, n)', '(p, q) with p, q > 0', '(0, 0)'],
      correctIndex: 0,
      difficulty: 'easy',
  ...
  medium: [
    {
      ...
      options: ['The identity matrix', 'A triangular matrix', 'A diagonal matrix', 'The zero matrix'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Basis-dependent', 'Always (n, 0)', 'Not defined', 'An invariant of the form'],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['The same signature', 'The same entries', 'The same determinant', 'The same trace'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['(n, 0)', '(p, q) with both p > 0 and q > 0', '(0, n)', '(0, 0)'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['The rank', 'The trace', 'The number of negative diagonal entries (in diagonalized form)', 'Zero'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['f(u,v) = Q(u)Q(v)', 'f(u,v) = Q(u)/Q(v)', 'Cannot be recovered', 'f(u,v) = ½[Q(u+v) - Q(u) - Q(v)]'],
      correctIndex: 3,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['Diagonalized in general', 'Defined', 'Zero', 'Symmetric'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['f is positive on W', 'W = V', 'f = 0 on W (f(u,v) = 0 for all u,v ∈ W)', 'W = {0}'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['If f ⊕ g ≅ f ⊕ h, then g ≅ h', 'All forms are equivalent', 'f ≅ -f', 'Nothing can be cancelled'],
      correctIndex: 0,
      difficulty: 'hard',
...
export const section58Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['All 1', 'All 0', 'All -1', 'Arbitrary'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  medium: [
    {
      ...
      options: ['[[0,I],[-I,0]]', 'I', 'A diagonal matrix', 'The zero matrix'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Different', 'Zero', 'Equivalent to the standard symplectic form', 'Positive'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['The inner product', 'The determinant', 'Eigenvalues', 'A symplectic form'],
      correctIndex: 3,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['dim(L) = dim(V)', 'L = V', 'dim(L) = ½ dim(V) and ω|_L = 0', 'L = {0}'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Arbitrary', 'Different everywhere', 'Zero', 'The standard form (no local invariants)'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['All matrices', 'Symmetric matrices', 'Skew-symmetric matrices of even size', 'Unitary matrices'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Pf(BABᵀ) = Pf(A)', 'Pf(BABᵀ) = Pf(B)Pf(A)', 'No simple rule', 'Pf(BABᵀ) = det(B)Pf(A)'],
      correctIndex: 3,
      difficulty: 'hard',
  ...
  easy: [
    {
      ...
      options: ['The standard inner product on ℝⁿ', 'Any bilinear form', 'Only the zero form', 'Determinant'],
      correctIndex: 0,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['U(n)', 'Symmetric matrices', 'Nilpotent matrices', 'Matrices with det = 1'],
      correctIndex: 3,
      difficulty: 'easy',
  ...
  medium: [
    {
      id: 's59-m01',
      question: 'The symplectic group Sp(2n) preserves:',
      options: ['The inner product', 'The determinant', 'A non-degenerate skew-symmetric form', 'Eigenvalues'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Euclidean distance', 'The zero form', 'Volume', 'The Minkowski metric (signature (1,3) or (3,1))'],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      id: 's59-m06',
      question: 'O(n) has:',
      options: ['One connected component', 'n components', 'Infinitely many components', 'Two connected components (det = ±1)'],
      correctIndex: 3,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['Skew-symmetric matrices', 'Symmetric matrices', 'All matrices', 'Diagonal matrices'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Never surjective', 'Only defined at 0', 'Always surjective', 'Not continuous'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['The same as SO(n)', 'A subgroup of O(n)', 'Abelian', 'A double cover of SO(n)'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['U(n)', 'Sp(2n, ℝ) itself', 'O(2n)', 'SU(n)'],
      correctIndex: 0,
      difficulty: 'hard',
...
export const chapter10Quiz: DifficultyQuizData = {
  ...
  hard: [
    ...
    },
    {
      id: 'ch10-h06',
      question: 'Over ℂ, all non-degenerate symmetric bilinear forms on ℂⁿ are:',
      options: ['Different', 'Not comparable', 'All positive definite', 'Equivalent (congruent)'],
      correctIndex: 3,
      difficulty: 'hard',
      explanation: 'Over ℂ, any non-degenerate symmetric form is congruent to the sum of squares.'
    },
    ...
    },
    {
      id: 'ch10-h09',
      question: 'From quadratic form Q, the bilinear form f can be recovered (char ≠ 2) via:',
      options: ['f(u,v) = Q(u+v)', 'f(u,v) = Q(u)Q(v)', 'f(u,v) = ½[Q(u+v) - Q(u) - Q(v)]', 'Cannot be recovered'],
      correctIndex: 2,
      difficulty: 'hard',
      explanation: 'Polarization identity: f(u,v) = ½[Q(u+v) - Q(u) - Q(v)].'
    },
