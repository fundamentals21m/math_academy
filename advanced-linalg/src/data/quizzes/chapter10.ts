...
export const section56Quiz: DifficultyQuizData = {
  ...
  medium: [
    ...
    },
    {
      ...
      options: [
      'f = 0',
      'The only v with f(v,w) = 0 for all w is v = 0',
      'f(v,v) > 0 for all v',
      'f is symmetric',
    ],
      correctIndex: 1,
...
export const section57Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: [
      '(# positive, # negative diagonal entries in diagonalized form)',
      'Its determinant',
      'Always (n, 0)',
      'Undefined',
    ],
  ...
  medium: [
    ...
    },
    {
      ...
      'The trace',
      'Zero',
      'The number of negative diagonal entries (in diagonalized form)',
    ],
      correctIndex: 3,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      'The signature',
      'Zero',
      'The dimension of a maximal isotropic subspace',
    ],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: [
      'f = 0 on W (f(u,v) = 0 for all u,v ∈ W)',
      'f is positive on W',
      'W = V',
      'W = {0}',
    ],
    ...
    },
    {
      ...
      'The whole form',
      'The radical',
      'What remains after removing all hyperbolic planes',
    ],
      correctIndex: 3,
      difficulty: 'hard',
...
export const section58Quiz: DifficultyQuizData = {
  ...
  medium: [
    ...
    },
    {
      ...
      options: [
      'Different',
      'Equivalent to the standard symplectic form',
      'Zero',
      'Positive',
    ],
      correctIndex: 1,
  ...
  hard: [
    ...
    },
    {
      ...
      'Zero',
      'The standard form (no local invariants)',
    ],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: [
      'All matrices',
      'Skew-symmetric matrices of even size',
      'Symmetric matrices',
      'Unitary matrices',
    ],
      correctIndex: 1,
...
export const section59Quiz: DifficultyQuizData = {
  ...
  medium: [
    ...
    },
    {
      ...
      'The zero form',
      'Volume',
      'The Minkowski metric (signature (1,3) or (3,1))',
    ],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      ...
      question: 'O(n) has:',
      options: [
      'Two connected components (det = ±1)',
  ...
  hard: [
    ...
    },
    {
      ...
      'G = K × K',
      'G is simple',
      'G = K · exp(p) where K is maximal compact',
      'G = {e}',
    ],
      correctIndex: 2,
      difficulty: 'hard',
