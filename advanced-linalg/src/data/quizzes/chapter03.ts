...
export const section13Quiz: DifficultyQuizData = {
  easy: [
    {
      ...
      options: ['{w ∈ W : T(v) = w for some v}', 'V', '{v ∈ V : T(v) = 0}', 'W'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Linear', 'Not linear', 'An isomorphism', 'Not well-defined'],
      correctIndex: 0,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Not linear', 'A linear isomorphism', 'Linear but not bijective', 'Only defined for finite-dimensional V'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Not linear', 'Not well-defined', 'Linear', 'Only linear for x = y'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Linear', 'An isomorphism', 'Has trivial kernel', 'Not linear'],
      correctIndex: 3,
      difficulty: 'easy',
  ...
  medium: [
    {
      ...
      options: ['T(αv + βw) = αT(v) + βT(w) for all scalars α, β and vectors v, w', 'T is bijective', 'T(0) = 0', 'T is surjective'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['T is surjective', 'Im(T) = W', 'ker(T) = {0}', 'T is the identity'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Not necessarily a subspace', 'Equal to W', 'Empty', 'A subspace of W'],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['dim(Im T)', 'dim(ker T)', 'dim(V)', 'dim(W)'],
      correctIndex: 0,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['T injective ⟺ T surjective ⟺ T isomorphism', 'T is always an isomorphism', 'T is never an isomorphism', 'T must be the zero map'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['All of V', 'Any basis for V', 'Any spanning set for V', 'Any single non-zero vector'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Never linear', 'Linear only if both are isomorphisms', 'Always linear', 'Linear only if both are the same'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['W must be finite-dimensional', 'ker(T) is infinite-dimensional', 'rank(T) = dim(V)', 'Im(T) is finite-dimensional'],
      correctIndex: 3,
      difficulty: 'hard',
...
export const section15Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['The zero matrix', 'Any invertible matrix', 'The n × n identity matrix', 'Undefined'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['T + U', 'TU (composition)', 'T - U', 'UT (composition)'],
      correctIndex: 3,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['The zero matrix', 'The identity matrix', 'Any matrix', 'No matrix'],
      correctIndex: 0,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['They have the same elements', 'One contains the other', 'They are equal', 'They have the same dimension'],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['B = P⁻¹AP for some invertible P', 'A = B', 'AB = BA', 'A + B = 0'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Symmetric', 'Invertible', 'Diagonal', 'Upper triangular'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Not linear', 'Not defined', 'Linear', 'Only partially defined'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Addition of transformations', 'Scalar multiplication', 'Taking transpose', 'Composition of transformations'],
      correctIndex: 3,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['Columns that are coordinate vectors of T(vᵢ)', 'Rows from T applied to B', 'All 1s', 'All 0s'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['The same entries', 'The same size only', 'The same rank, determinant, and eigenvalues', 'Nothing in common'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Not symmetric', 'Not transitive', 'Not reflexive', 'An equivalence relation'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['They have the same characteristic polynomial', 'A = B', 'They have different ranks', 'One is the transpose of the other'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['A field', 'A group under multiplication', 'A vector space', 'A ring'],
      correctIndex: 1,
      difficulty: 'hard',
...
export const section17Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['Not linear', 'An isomorphism', 'Not well-defined', 'A linear functional'],
      correctIndex: 3,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['The set of all functions from V to F', 'V', 'The power set of V', 'F'],
      correctIndex: 0,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Is not in V*', 'Is not linear', 'Is the zero vector of V*', 'Is an isomorphism'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['f₁(e₁) = 0', 'f₁(eᵢ) = 1 for all i', 'f₁ = e₁', 'f₁(e₁) = 1, f₁(e₂) = f₁(e₃) = 0'],
      correctIndex: 3,
      difficulty: 'easy',
  ...
  medium: [
    {
      ...
      options: ['The space of all linear functionals on V', 'Equal to V', 'Always infinite-dimensional', 'A subspace of V'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['fᵢ(vⱼ) = 0 for all i,j', 'fᵢ(vⱼ) = 1 for all i,j', 'fᵢ(vⱼ) = δᵢⱼ (Kronecker delta)', 'fᵢ = vᵢ'],
      correctIndex: 2,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['A subspace of V', 'Equal to W', 'A subspace of V*', 'Equal to V*'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['dim(W)', 'dim(V*)', '0', 'dim(V) - dim(W)'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['An isomorphism when V is finite-dimensional', 'Not injective', 'The zero map', 'Not linear'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Any isomorphism', 'The canonical evaluation map', 'A basis-dependent isomorphism', 'The identity'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['The same as T', 'The inverse of the matrix of T', 'The transpose of the matrix of T', 'Unrelated to T'],
      correctIndex: 2,
      difficulty: 'hard',
  ...
  hard: [
    {
      id: 'ch03-h01',
      question: 'The zero transformation T(v) = 0 for all v is:',
      options: ['Linear but not injective', 'Not linear', 'An isomorphism', 'Not well-defined'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['A field', 'A vector space only', 'Neither', 'An algebra'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Associative', 'Commutative', 'Both', 'Neither'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['The fundamental theorem', 'Sylvester\'s law', 'The rank-nullity theorem', 'The dimension formula'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      id: 'ch03-h08',
      question: 'If dim(V) = dim(W) and T: V → W is linear, then:',
      options: ['T is always an isomorphism', 'T is never an isomorphism', 'T must be the zero map', 'T injective ⟺ T surjective ⟺ T isomorphism'],
      correctIndex: 3,
      difficulty: 'hard',
      explanation: 'For equal finite dimensions, injective ⟺ surjective ⟺ bijective.'
    },
    {
      ...
      options: ['The identity matrix Iₙ', 'The zero matrix', 'A diagonal matrix with all diagonal entries equal to n', 'Depends on the basis'],
      correctIndex: 0,
      difficulty: 'hard',
