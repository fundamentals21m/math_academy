  ...
  easy: [
    {
      ...
      options: [
      'Only real spaces',
      'Sesquilinear forms and their operators',
      'Only finite fields',
      'Matrices only',
    ],
      correctIndex: 1,
  ...
  medium: [
    {
      ...
      'f(u,v) = ||u|| ||v||',
      'f(u,v) = 0',
      'f(u,v) = ⟨Tu,v⟩ for unique operator T',
      'f(u,v) = ⟨u,v⟩',
    ],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      'Always diagonal',
      'Always symmetric',
      'The same as the operator matrix',
      'Not well-defined',
    ],
      correctIndex: 2,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      'f(u,v) = Q(u)/Q(v)',
      'Cannot be recovered',
      'f(u,v) = Q(u+v) - Q(u) - Q(v) with suitable scaling',
    ],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      'Signature (n, 0)',
      'f(v,v) = 0 for all v',
      'Both positive and negative values of f(v,v)',
      'Signature (0, n)',
    ],
      correctIndex: 2,
      difficulty: 'hard',
...
export const section51Quiz: DifficultyQuizData = {
  ...
  medium: [
    ...
    },
    {
      ...
      options: [
      'T > 0 (all eigenvalues > 0)',
      'T ≥ 0',
      'T = 0',
      'T is invertible only',
    ],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      'Diagonalization then taking square roots',
    ],
      correctIndex: 3,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      'Eigenvalues of T',
      'Eigenvalues of T*T',
      'Square roots of eigenvalues of T*T',
      'Entries of T',
    ],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      'T = T* + iT',
      'T = D + N',
      'T = UP where U is unitary and P is positive',
      'T = LU',
    ],
      correctIndex: 2,
      difficulty: 'hard',
...
export const section54Quiz: DifficultyQuizData = {
  ...
  medium: [
    {
      ...
      options: [
      'Sum of nilpotent operators',
      'Product of reflections',
      'T = I',
      'Sum λᵢEᵢ where Eᵢ are orthogonal projections',
    ],
      correctIndex: 3,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: [
      'Is always diagonalizable over ℝ',
      'Has no eigenvalues',
      'Is always zero',
      'May have complex eigenvalues (coming in conjugate pairs)',
    ],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: [
      'Any continuous function f(T)',
      'Only polynomials in T',
      'Nothing',
      'Only f(T) = T',
    ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
      'Normal operators are diagonal',
      'T* = T always',
      'If N is normal and TN = NT, then TN* = N*T',
      'All operators are normal',
    ],
      correctIndex: 2,
      difficulty: 'hard',
...
export const chapter09Quiz: DifficultyQuizData = {
  ...
  hard: [
    ...
    },
    {
      ...
      question: 'The singular value decomposition writes T as:',
      options: [
      'UDV where U, V unitary and D diagonal with singular values',
      'T = T*',
      'LU',
      'QR',
    ],
