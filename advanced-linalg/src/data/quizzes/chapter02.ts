...
export const section07Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['cv = v', 'cv is undefined', 'cv = -v', 'cv = 0'],
      correctIndex: 3,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['c · 0 = 0', 'c · 0 = c', 'c · 0 = 1', 'c · 0 is undefined'],
      correctIndex: 0,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['ℤ only', 'ℂ only', 'Both ℝ and ℂ', 'ℝ only'],
      correctIndex: 3,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['Scalar multiplication only', 'Vector addition only', 'Both operations', 'Neither operation'],
      correctIndex: 1,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['Not a vector space', 'A finite-dimensional vector space', 'A field', 'An infinite-dimensional vector space'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['All of the above', 'Only ℂ', 'ℝ', 'ℚ'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['A vector space', 'A subspace of F[x]', 'Not a vector space', 'A field'],
      correctIndex: 2,
      difficulty: 'hard',
  ...
  easy: [
    {
      ...
      options: ['Subspaces are closed under scalar multiplication (0 · v = 0)', 'It is defined that way', 'Subspaces are non-empty', 'The zero vector spans everything'],
      correctIndex: 0,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Not a subspace', 'A 2-dimensional subspace', 'Equal to ℝ²', 'A 1-dimensional subspace'],
      correctIndex: 3,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Not a subspace', 'A subspace', 'A 1-dimensional subspace', 'The whole space'],
      correctIndex: 0,
      difficulty: 'easy',
  ...
  medium: [
    {
      ...
      options: ['W contains 0', 'W equals V', 'W is closed under addition and scalar multiplication', 'W is finite'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Empty', 'Not a subspace', 'Equal to V', 'A subspace'],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['The smallest subspace containing S', 'The largest subspace containing S', 'Equal to S', 'The empty set'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Equals W₁ ∪ W₂', 'Is contained in W₁ ∩ W₂', 'Contains both W₁ and W₂', 'Equals W₁ ∩ W₂'],
      correctIndex: 2,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['A subspace of the column space', 'A subspace of the codomain', 'Never a subspace', 'A subspace of the domain'],
      correctIndex: 3,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['Only if one contains the other', 'Always', 'Never', 'Only if they are equal'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['W₁ × W₂', 'W₁ + W₂ where W₁ ∩ W₂ = {0}', 'W₁ ∪ W₂', 'W₁ ∩ W₂'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['v = w₁ or v = w₂', 'v = w₁w₂', 'v = w₁ + w₂ with w₁ ∈ W₁, w₂ ∈ W₂', 'v = w₁ - w₂'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['W₁ + W₂ = V', 'W₁ = W₂', 'W₁ ⊆ W₂', 'dim(W₁) = dim(W₂)'],
      correctIndex: 0,
      difficulty: 'hard',
...
export const section09Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['{(1,1,1)}', 'Any three vectors', '{(1,0,0), (1,1,0)}', '{(1,0,0), (0,1,0), (0,0,1)}'],
      correctIndex: 3,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['They are perpendicular', 'They have the same length', 'One is a scalar multiple of the other', 'They point in opposite directions'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Linearly independent', 'A basis', 'Spanning', 'Linearly dependent'],
      correctIndex: 3,
      difficulty: 'easy',
  ...
  medium: [
    {
      ...
      options: ['The only linear combination equal to 0 is the trivial one', 'They span V', 'They are orthogonal', 'There are n of them'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['At most n elements', 'Exactly n elements', 'At least n elements', 'More than n elements'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Must be linearly independent', 'Is a basis', 'Spans V', 'Cannot span V'],
      correctIndex: 3,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['One is a linear combination of the others', 'v₁ + v₂ + v₃ = 0', 'They span a 3-dimensional space', 'All are zero'],
      correctIndex: 0,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['Made smaller', 'Made orthogonal', 'Extended to a basis', 'Reduced to a single vector'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Exactly dim(V) vectors', 'At most dim(V) vectors', 'No linearly independent vectors', 'At least dim(V) vectors'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Either linearly independent or spanning', 'Linearly independent', 'Spanning', 'Orthogonal'],
      correctIndex: 0,
      difficulty: 'hard',
...
export const chapter02Quiz: DifficultyQuizData = {
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['A unique basis', 'Infinitely many bases', 'No basis', 'At least one basis'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['rank + nullity = m', 'rank · nullity = mn', 'rank + nullity = n', 'rank - nullity = m'],
      correctIndex: 2,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['The set is a basis', 'The set is linearly independent', 'V = {0}', 'The set is linearly dependent'],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['ker(T) = {0}', 'ker(T) = V', 'im(T) = W', 'T is surjective'],
      correctIndex: 0,
      difficulty: 'hard',
