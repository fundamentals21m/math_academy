...
export const section07Quiz: DifficultyQuizData = {
  ...
  hard: [
    ...
    },
    {
      ...
      options: [
      'Not a vector space (not closed under addition)',
      'A vector space',
      'A subspace of ℝ²',
...
export const section08Quiz: DifficultyQuizData = {
  easy: [
    {
      ...
      'Subspaces are non-empty',
      'Subspaces are closed under scalar multiplication (0 · v = 0)',
      'The zero vector spans everything',
    ],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      'Only V itself',
      'Nothing',
      'V and any larger space containing it',
    ],
      correctIndex: 3,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: [
      'A subspace of the column space',
...
export const section09Quiz: DifficultyQuizData = {
  ...
  medium: [
    {
      ...
      options: [
      'They span V',
      'The only linear combination equal to 0 is the trivial one',
      'They are orthogonal',
      'There are n of them',
    ],
      correctIndex: 1,
    ...
    },
    {
      ...
      options: [
      'v₁ + v₂ + v₃ = 0',
      'They span a 3-dimensional space',
  ...
  hard: [
    ...
    },
    {
      ...
      options: [
      'Exactly dim(V) vectors',
      'At most dim(V) vectors',
      'No linearly independent vectors',
      'At least dim(V) vectors',
    ],
      correctIndex: 3,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: [
      'Either linearly independent or spanning',
      'Linearly independent',
      'Spanning',
      'Orthogonal',
    ],
