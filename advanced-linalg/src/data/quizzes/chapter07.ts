...
export const section40Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['1', 'dim(V)', 'deg of the T-annihilator of v', 'The rank of T'],
      correctIndex: 2,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Equal to V', 'T-invariant', 'One-dimensional', 'Empty'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['The characteristic polynomial', 'The minimal polynomial of T', 'Both characteristic and minimal polynomials', 'Nothing'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['T = 0', 'The minimal polynomial equals the characteristic polynomial', 'T is diagonalizable', 'T is nilpotent'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['v = 0', 'v is a cyclic vector', 'T = I', 'The minimal polynomial is 1'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['0', 'At most dim(V)', 'Exactly n', 'Infinite'],
      correctIndex: 1,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['v = 0', 'Z(v;T) has no proper T-invariant subspace', 'T is diagonalizable', 'v is an eigenvector'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['f₁', 'fₖ', 'f₁f₂...fₖ', 'gcd of all fᵢ'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['They have the same trace', 'They have the same invariant factors', 'They have the same eigenvalues', 'They are equal'],
      correctIndex: 1,
      difficulty: 'hard',
...
export const section41Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['Identity blocks', 'Companion matrices', 'Diagonal matrices', 'Zero blocks'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['The choice of basis', 'Only the operator', 'The field extension', 'Random choices'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Diagonal', 'A single companion matrix', 'Block diagonal', 'The identity'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  hard: [
    {
      ...
      options: ['Diagonalize matrices', 'Compute invariant factors of xI - A', 'Find eigenvalues', 'Compute determinants'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Zero', 'dim(V) - rank(similarity invariants)', 'Always n', 'Undefined'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Eigenvalues', 'Invariant factors', 'Elementary divisors', 'Jordan blocks'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Computing anything', 'Finding eigenvalues', 'Using any field', 'The characteristic polynomial'],
      correctIndex: 1,
      difficulty: 'hard',
...
export const section42Quiz: DifficultyQuizData = {
  easy: [
    ...
    },
    {
      ...
      options: ['Diagonal matrix', 'Nilpotent matrix', 'Identity matrix', 'Scalar matrix'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  medium: [
    ...
    },
    {
      ...
      options: ['n', 'n - (number of Jordan blocks)', 'The trace', '0'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['The number of blocks', 'The sum of sizes of blocks for λ', 'Always 1', 'The trace'],
      correctIndex: 1,
      difficulty: 'medium',
  ...
  hard: [
    ...
    },
    {
      ...
      options: ['J₂(λ²)', 'J₂(λ)²', 'Diagonal', 'Not a Jordan form'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['(T-λI)^k v = 0 but (T-λI)^{k-1}v ≠ 0', 'Tv = λv', 'T^k v = 0', 'v = 0'],
      correctIndex: 0,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['A sequence of eigenvalues', 'Vectors v, (T-λI)v, ..., (T-λI)^{k-1}v', 'The blocks', 'The invariant factors'],
      correctIndex: 1,
      difficulty: 'hard',
  ...
  easy: [
    {
      ...
      options: ['The trace', 'The eigenvalues', 'The dimension', 'The inverse'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['All entries in F', 'Diagonal polynomial entries', 'Random polynomials', 'Only constants'],
      correctIndex: 1,
      difficulty: 'easy',
    ...
    },
    {
      ...
      options: ['Nilpotent', 'Diagonalizable', 'The identity', 'Zero'],
      correctIndex: 1,
      difficulty: 'easy',
  ...
  medium: [
    {
      ...
      options: ['Eigenvalues directly', 'The invariant factors', 'The Jordan form', 'The determinant'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Prime power factors of invariant factors', 'The eigenvalues', 'Always linear', 'The trace'],
      correctIndex: 0,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['Invariant factors', 'Elementary divisors', 'The trace', 'Eigenvalues only'],
      correctIndex: 1,
      difficulty: 'medium',
    ...
    },
    {
      ...
      options: ['S and N are unique', 'Only S is unique', 'Only N is unique', 'Neither is unique'],
      correctIndex: 0,
      difficulty: 'medium',
  ...
  hard: [
    {
      ...
      options: ['d₁ = d₂ = ... = dₙ', 'd₁ | d₂ | ... | dₙ', 'No relation', 'dᵢ = xⁱ'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['The matrix itself', 'The similarity class of A', 'Nothing', 'Only the determinant'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['n', 'The number of non-trivial cyclic summands', 'Zero', 'One'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Addition', 'fₖ = dₖ/dₖ₋₁', 'Multiplication', 'fₖ = dₖ + dₖ₋₁'],
      correctIndex: 1,
      difficulty: 'hard',
    ...
    },
    {
      ...
      options: ['Guessing', 'The eigenvectors', 'Fitting polynomials in T to interpolation conditions', 'Taking limits'],
      correctIndex: 2,
      difficulty: 'hard',
