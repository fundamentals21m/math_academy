...
export function SectionQuiz({ 
  ...
  const handleNumericAnswer = () => {
    if (numericAnswer === null || Number.isNaN(numericAnswer) || !currentQuestion) {
  ...
  const handleNext = () => {
    if (currentIndex < totalQuestions - 1) {
      ...
      if (currentQuestion && selectedDifficulty) {
        ...
        // Calculate XP earned
        let xpEarned = calculateXP(selectedDifficulty, finalPercentage);
