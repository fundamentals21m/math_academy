 ...
 */
export const COURSE_ID = 'human_action' as CourseId;

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Human Action';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = "Ludwig von Mises' treatise on economics - the foundational text of Austrian Economics";
