...
export const section00Questions: QuizQuestion[] = [
  ...
  },
  {
    id: 4,
    type: 'multiple-choice',
    question: 'According to Mises, what does every action imply?',
    options: [
    ...
    correctIndex: 1,
    difficulty: 'easy',
    explanation: 'Action implies uneasiness (dissatisfaction with the present) and the belief that purposeful behavior can remove or reduce that uneasiness.',
  },
  {
    id: 5,
    type: 'multiple-choice',
  ...
  },
  {
    id: 6,
    type: 'multiple-choice',
    question: 'What is the title of Mises\' treatise that this course covers?',
    options: [
    ...
    correctIndex: 2,
    difficulty: 'easy',
    explanation: 'Human Action: A Treatise on Economics is Mises\' comprehensive work on praxeology and economics.',
  },
];
