 ...
 */
export const COURSE_ID: CourseId = 'euclid';

/**
 * Human-readable course name
 */
export const COURSE_NAME = "Euclid's Elements";

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'The foundational text of Western mathematics. Study all 13 books covering plane geometry, proportions, number theory, and solid geometry through interactive propositions and proofs.';
