...
/**
 * Postulate block - rose gradient, used for Euclidean postulates
 */
export function Postulate({ title, children, className = '' }: ContentBlockProps) {
  return (
    <div
      className={`my-6 p-6 rounded-2xl bg-gradient-to-br from-rose-500/10 to-rose-600/5 border border-rose-500/20 ${className}`}
    >
      <div className="flex items-start gap-3 mb-3">
...
/**
 * Common Notion block - cyan gradient, used for Euclid's common notions
 */
export function CommonNotion({ title, children, className = '' }: ContentBlockProps) {
  return (
    <div
            ...
            {showProof && (
              ...
              >
                <div className="mt-4 p-4 rounded-xl bg-dark-800/50 border border-dark-700/50 text-dark-300">
                  ...
                  {proof}
                  <div className="text-right mt-4 text-dark-500">Q.E.D.</div>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
