 ...
 */
export const COURSE_ID: CourseId = 'lcn';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Little Crypto Notebook';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'Advanced cryptography: commitments, zero-knowledge proofs, and multi-signatures';
