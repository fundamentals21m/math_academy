 ...
 */
export const COURSE_ID: CourseId = 'branta';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Branta';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'Learn Bitcoin transaction security with Branta Guardrail';
