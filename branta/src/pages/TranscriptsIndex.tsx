        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-dark-400">
                  Podcast interviews and articles about Branta and Bitcoin security
                </p>
              </div>
            </div>

            <p className="text-dark-400 text-sm max-w-3xl">
              Curated summaries from podcast appearances and articles featuring Keith Gardner
              and the Branta team discussing pre-payment verification, Bitcoin security threats,
              and the Guardrail product.
            </p>
          </div>
          ...
          <div className="mt-12 p-6 rounded-2xl bg-dark-800/30 border border-dark-700/30">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-dark-100 font-semibold mb-1">More from Branta</h3>
                <p className="text-dark-400 text-sm mb-3">
                  Follow Branta for the latest updates on Bitcoin transaction security.
                </p>
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://brantaops.substack.com/"
                    target="_blank"
