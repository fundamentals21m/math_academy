...
const modules: InteractiveModule[] = [
  {
    id: 'address-verifier',
    title: 'Address Verification Flow',
    description: 'Interactive walkthrough of the Guardrail verification process from registration to verification.',
    sectionId: 6,
  ...
  {
    id: 'attack-simulator',
    title: 'Attack Vector Visualizer',
    description: 'Explore how different attack types (clipboard hijacking, MITM, phishing) affect Bitcoin transactions.',
    sectionId: 2,
  ...
  },
  {
    ...
    description: 'Build and understand Branta API requests for adding and getting payments.',
    sectionId: 9,
  ...
  },
  {
    ...
    description: 'Convert between different time units and understand TTL implications for your use case.',
    sectionId: 11,
