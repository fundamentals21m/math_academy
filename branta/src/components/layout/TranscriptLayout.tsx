  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="sticky top-16 z-30 h-1 bg-dark-900/80 backdrop-blur">
        <div
          className="h-full bg-gradient-to-r from-amber-600 via-amber-500 to-primary-400 transition-all duration-500 ease-out"
      ...
      <article className="relative max-w-4xl mx-auto px-6 py-12">
        ...
        <header className="mb-14">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="bg-gradient-to-r from-amber-400 via-amber-300 to-primary-400 bg-clip-text text-transparent">
              {transcript.title}
            </span>
          </h1>
            ...
            <div className="flex flex-wrap gap-3">
              {transcript.speakers.map((speaker, idx) => (
                <div key={idx} className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-amber-500/30 to-primary-500/30 flex items-center justify-center">
