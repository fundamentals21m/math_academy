        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-dark-400">
                  Podcast and conference discussions on threshold signatures
                </p>
              </div>
            </div>
            ...
            <p className="text-dark-400 text-sm max-w-3xl">
              ...
              behind FROST threshold signatures. These transcripts cover FROST, ROAST, MuSig2,
              distributed key generation, and multi-party signing protocols.
            </p>
          </div>
