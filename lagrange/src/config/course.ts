 ...
 */
export const COURSE_ID: CourseId = 'lagrange';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Mécanique analytique (Lagrange)';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'Master analytical mechanics: Lagrangian and Hamiltonian formulations, non-inertial reference frames, and rigid body dynamics';
