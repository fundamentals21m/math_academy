  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="sticky top-16 z-30 h-1 bg-dark-900/80 backdrop-blur">
        <div
          className="h-full bg-gradient-to-r from-amber-600 via-amber-500 to-orange-400 transition-all duration-500 ease-out"
      ...
      <article className="relative max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-12 p-6 rounded-2xl bg-gradient-to-br from-orange-500/10 to-amber-600/5 border border-amber-500/20">
      ...
      <nav className="relative max-w-4xl mx-auto px-6 py-12 border-t border-dark-800/50">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {next ? (
            ...
            <Link
              to="/transcripts"
              className="group flex items-center justify-center gap-3 p-5 rounded-2xl bg-gradient-to-r from-amber-600 to-orange-500 text-white font-semibold shadow-lg shadow-amber-500/20 hover:shadow-xl hover:shadow-amber-500/30 hover:scale-[1.02] transition-all duration-300"
            >
