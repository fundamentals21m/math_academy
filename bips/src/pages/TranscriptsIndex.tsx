        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500/20 to-orange-600/10 flex items-center justify-center">
                <span className="text-2xl">🎙️</span>
              </div>
              <div>
                <h1 className="text-3xl font-bold text-dark-100">Transcripts</h1>
                <p className="text-dark-400">
                  Talks and interviews about Bitcoin protocol development
                </p>
              </div>
            </div>

            <p className="text-dark-400 text-sm max-w-3xl">
              Curated summaries from leading Bitcoin Core developers and researchers discussing
              BIPs, consensus changes, and protocol improvements.
            </p>
          </div>
            ...
            {filteredTranscripts.map((transcript) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-amber-500/20 to-orange-600/10 flex items-center justify-center flex-shrink-0">
                    <span className="text-2xl">🎙️</span>
                  </div>
          ...
          <div className="mt-12 p-6 rounded-2xl bg-dark-800/30 border border-dark-700/30">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-dark-100 font-semibold mb-1">Featured Developers</h3>
                <p className="text-dark-400 text-sm mb-3">
                  These transcripts feature leading Bitcoin Core contributors:
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="text-xs px-3 py-1 rounded-full bg-dark-700 text-dark-300">
                    Pieter Wuille - SegWit, Taproot
                  </span>
                  <span className="text-xs px-3 py-1 rounded-full bg-dark-700 text-dark-300">
                    Gloria Zhao - Bitcoin Core Maintainer
                  </span>
                  <span className="text-xs px-3 py-1 rounded-full bg-dark-700 text-dark-300">
                    Tim Ruffing - MuSig, Schnorr
                  </span>
                  <span className="text-xs px-3 py-1 rounded-full bg-dark-700 text-dark-300">
                    Murch - BIP Editor
                  </span>
