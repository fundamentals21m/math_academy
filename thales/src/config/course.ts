 ...
 */
export const COURSE_ID: CourseId = 'thales';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'The Heritage of Thales';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'Journey through 2,500 years of mathematical history, from ancient Egypt and Babylon through Greek mathematics, the Renaissance, and into modern foundations including set theory, logic, and category theory.';
