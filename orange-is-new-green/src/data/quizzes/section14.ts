...
export const section14Questions: QuizQuestion[] = [
  ...
  },
  {
    id: 3,
    type: 'multiple-choice',
    question: 'What two complementary instruments does the paper propose until fiat fades away?',
    options: [
      'Stocks and bonds',
    ...
    correctIndex: 1,
    difficulty: 'easy',
    explanation: 'The paper proposes Bitcoin for long-term savings and Bitcoin-based MMFs for short-term cash balances—until fiat fades and Bitcoin can serve both roles.',
  },
  {
    id: 4,
    type: 'multiple-choice',
