 ...
 */
export const COURSE_ID: CourseId = 'orange_btc';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Orange is the New Green';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'The emergence of Bitcoin money market funds and how Bitcoin can absorb short-term cash balances';
