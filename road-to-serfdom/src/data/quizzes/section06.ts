...
export const section06Questions: QuizQuestion[] = [
  {
    ...
    question: 'According to Hayek, all forms of collectivism are "totalitarian" because they:',
    options: [
      'Use violence',
    ...
    correctIndex: 1,
    difficulty: 'medium',
    explanation: 'All collectivist systems—communism, fascism, socialism—are totalitarian because they want to organise the whole of society for a unitary end, refusing to recognise spheres where individual ends are supreme.',
  },
  {
    id: 2,
    type: 'multiple-choice',
  ...
  },
  {
    id: 4,
    type: 'multiple-choice',
    question: 'What happens to the probability of agreement as the scope of collective action extends?',
    options: [
      'It increases',
      'It stays the same',
    ...
    correctIndex: 2,
    difficulty: 'easy',
    explanation: 'The probability of agreement necessarily decreases as scope extends—from unanimity on basic functions to substantial majorities, eventually reaching fields where there are as many views as people.',
  },
  {
    id: 5,
    type: 'multiple-choice',
