...
export const section12Questions: QuizQuestion[] = [
  ...
  },
  {
    id: 4,
    type: 'multiple-choice',
    question: 'The founders Fichte, Rodbertus, and Lassall are acknowledged as:',
    options: [
      'Only liberal thinkers',
      'Both ancestors of National-Socialism AND fathers of socialism',
      'Only Nazi ideologists',
      'Only economists'
    ],
    correctIndex: 1,
    difficulty: 'medium',
    explanation: 'The most important ancestors of National-Socialism—Fichte, Rodbertus, Lassall—are at the same time acknowledged fathers of socialism, showing the shared roots.',
  },
  {
    id: 5,
    type: 'multiple-choice',
    question: 'Spengler wrote that "Old Prussian spirit and socialist conviction... are":',
    options: [
      'Complete opposites',
      'One and the same',
      'Unrelated',
    ...
    correctIndex: 1,
    difficulty: 'easy',
    explanation: 'Spengler declared that "Old Prussian spirit and socialist conviction, which to-day hate each other with the hatred of brothers, are one and the same."',
  },
  {
    id: 6,
    type: 'multiple-choice',
