 ...
 */
export const COURSE_ID: CourseId = 'road_to_serfdom';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'The Road to Serfdom';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'An interactive course exploring F.A. Hayek\'s classic work on freedom, central planning, and the dangers of collectivism';
