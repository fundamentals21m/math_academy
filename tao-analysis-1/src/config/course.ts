 ...
 */
export const COURSE_ID: CourseId = 'tao-analysis-1';

/**
 * Human-readable course name
 */
export const COURSE_NAME = "Tao's Analysis I";

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'A rigorous introduction to real analysis, building from the Peano axioms through the construction of real numbers, sequences, series, continuity, differentiation, and Riemann integration.';
