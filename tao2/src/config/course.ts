 ...
 */
export const COURSE_ID: CourseId = 'tao2';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Analysis II';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'An interactive course based on Terence Tao\'s Analysis II';
