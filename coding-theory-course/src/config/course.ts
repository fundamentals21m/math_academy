 ...
 */
export const COURSE_ID: CourseId = 'coding';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Algebraic Coding Theory';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'An interactive course on error-correcting codes based on Vermani\'s "Elements of Algebraic Coding Theory"';
