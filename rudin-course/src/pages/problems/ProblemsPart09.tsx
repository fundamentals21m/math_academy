      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Exercises covering linear transformations, multivariable differentiation, the Inverse Function Theorem,
            the Implicit Function Theorem, and differentiation of integrals.
          </p>
        </motion.div>
