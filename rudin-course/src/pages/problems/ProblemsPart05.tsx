      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Exercises covering the derivative, mean value theorems, the continuity of derivatives,
            L'Hôpital's rule, Taylor's theorem, and differentiation of vector-valued functions.
          </p>
        </motion.div>
