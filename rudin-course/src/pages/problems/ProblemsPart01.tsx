...
import problemData from '@/data/problems/part-01.json';

export default function ProblemsPart01() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Exercises covering ordered sets, fields, the real field, the extended real number system,
            the complex field, Euclidean spaces, and the construction of real numbers via Dedekind cuts.
          </p>
        </motion.div>
