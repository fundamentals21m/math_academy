      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Exercises covering Riemann-Stieltjes integration, upper and lower sums, properties of the integral,
            the Fundamental Theorem of Calculus, and rectifiable curves.
          </p>
        </motion.div>
