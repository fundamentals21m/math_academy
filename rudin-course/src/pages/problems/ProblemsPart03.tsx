...
export default function ProblemsPart03() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Exercises covering convergent sequences, subsequences, Cauchy sequences, upper and lower limits,
            series convergence, comparison tests, root and ratio tests, and power series.
          </p>
        </motion.div>
