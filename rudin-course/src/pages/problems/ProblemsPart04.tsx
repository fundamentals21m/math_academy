      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-400 mt-2">
            Exercises covering limits of functions, continuous functions, continuity and compactness,
            continuity and connectedness, discontinuities, and uniform continuity.
          </p>
        </motion.div>
