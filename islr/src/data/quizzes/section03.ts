...
export const section03Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Training error', 'Validation error', 'Test error', 'Cross-validation error'],
    correctIndex: 2,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Underfitting', 'Regularization', 'Cross-validation', 'Overfitting'],
    correctIndex: 3,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['100%', '50%', 'It depends on the data', '0%'],
    correctIndex: 3,
    difficulty: 'medium',
