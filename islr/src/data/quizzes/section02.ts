...
export const section02Quiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['Irreducible error', 'Reducible error', 'Training error', 'Model complexity'],
    correctIndex: 0,
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['Thin-plate splines', 'They are equally interpretable', 'It depends on the data', 'Linear regression'],
    correctIndex: 3,
    difficulty: 'medium',
