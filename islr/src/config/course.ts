 ...
 */
export const COURSE_ID: CourseId = 'islr';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Introduction to Statistical Learning';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = "An interactive course based on James et al.'s Introduction to Statistical Learning (2nd Edition)";
