 ...
 */
export const COURSE_ID: CourseId = 'orwell-1984';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Nineteen Eighty-Four';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = 'An interactive literature course exploring George Orwell\'s dystopian masterpiece';
