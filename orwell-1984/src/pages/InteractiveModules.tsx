...
const modules: InteractiveModule[] = [
  {
    ...
    description: 'Explore the chronology of events in Nineteen Eighty-Four, from the Revolution to Winston\'s fate.',
    sectionId: 0,
    sectionTitle: 'Part One, Chapter 1',
    category: 'Story',
    icon: '📅',
  },
  {
    ...
    description: 'Explore the characters and their connections—allies, enemies, and betrayers.',
    sectionId: 8,
    sectionTitle: 'Part Two, Chapter 1',
    category: 'Characters',
    icon: '👥',
  },
  {
    id: 'newspeak-dictionary',
    title: 'Newspeak Dictionary',
    description: 'Translate between Oldspeak and Newspeak. Learn how language control enables thought control.',
    sectionId: 24,
    sectionTitle: 'The Principles of Newspeak',
    category: 'Language',
    icon: '📖',
  },
  {
    id: 'doublethink-explorer',
    title: 'Doublethink Explorer',
    description: 'Examine the Party\'s contradictory slogans and practices. WAR IS PEACE. FREEDOM IS SLAVERY.',
    sectionId: 9,
    sectionTitle: 'Part Two, Chapter 2',
    category: 'Themes',
    icon: '🧠',
  },
  {
    id: 'power-structure',
    title: 'Power Structure of Oceania',
    description: 'Visualize the social hierarchy and the Four Ministries that control every aspect of life.',
    sectionId: 14,
    sectionTitle: 'Part Two, Chapter 7',
    category: 'World',
    icon: '🏛️',
  },
];
