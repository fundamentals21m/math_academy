 ...
 */
export const COURSE_ID: CourseId = 'gauss';

/**
 * Human-readable course name
 */
export const COURSE_NAME = 'Disquisitiones Arithmeticae';

/**
 * Short description for meta tags and headers
 */
export const COURSE_DESCRIPTION = "Gauss's foundational 1801 treatise that systematized number theory. Study congruences, quadratic residues, quadratic forms, and the construction of regular polygons.";
